...
---
## Highlights
Transitops `0.7.51` is a focused stability release for Transitops AI runtime access and shared date-time input editing. This release updates Transitops Console `0.7.51`, AI `0.0.2`, and Ember UI `0.3.41`.
...
---
## Transitops AI
- Added a non-admin runtime status endpoint so authenticated users can see and use the AI prompt when Transitops AI is enabled.
...
---
## Bug Fixes
- Fixed Transitops AI prompt availability for non-admin authenticated users when AI is enabled.
...
---
## API Changes
- Added a Transitops AI runtime status endpoint for authenticated users.
...
---
## Need help?
Join the discussion on [GitHub Discussions](https://github.com/transitops/transitops/discussions) or drop by [#transitops on Discord](https://discord.com/invite/HnTqQ6zAVn)
