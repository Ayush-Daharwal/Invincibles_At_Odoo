import { Widget } from '@transitops/ember-core/contracts';
import { faGithub } from '@fortawesome/free-brands-svg-icons';
import { debug } from '@ember/debug';

/**
 * Register dashboard and widgets for TransitopsConsole
...
export function initialize(appInstance) {
    ...
    universe.onBoot(() => {
        ...
        const widgets = [
            new Widget({
                id: 'transitops-blog',
                name: 'Transitops Blog',
                description: 'Lists latest news and events from the Transitops official team.',
                icon: 'newspaper',
                component: 'transitops-blog',
                grid_options: { w: 7, h: 9, minW: 7, minH: 9 },
                default: true,
            }),
            new Widget({
                id: 'transitops-github-card',
                name: 'Github Card',
                description: 'Displays current Github stats from the official Transitops repo.',
                icon: faGithub,
