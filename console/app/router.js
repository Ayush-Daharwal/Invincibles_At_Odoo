 ...
 * 
 * @generated
 * @copyright © 2026 Transitops Pte Ltd. All rights reserved.
...
Router.map(function () {
    ...
    this.route('console', { path: '/' }, function () {
        ...
        this.mount('@transitops/dev-engine', {
            as: 'developers',
            path: 'developers'
        });

        this.mount('@transitops/ai-engine', {
            as: 'ai',
            path: 'ai'
        });

        this.mount('@transitops/fleetops-engine', {
            as: 'fleet-ops',
            path: 'fleet-ops'
        });

        this.mount('@transitops/iam-engine', {
            as: 'iam',
            path: 'iam'
        });

        this.mount('@transitops/ledger-engine', {
            as: 'ledger',
            path: 'ledger'
        });

        this.mount('@transitops/registry-bridge-engine', {
            as: 'extensions',
            path: 'extensions'
        });

        this.mount('@transitops/storefront-engine', {
            as: 'storefront',
            path: 'storefront'
        });

        this.mount('@transitops/valhalla-engine', {
            as: 'valhalla',
            path: 'valhalla'
        });

        this.mount('@transitops/vroom-engine', {
            as: 'vroom',
            path: 'vroom'
        });
    });

    this.mount('@transitops/customer-portal-engine', {
        as: 'customer-portal',
