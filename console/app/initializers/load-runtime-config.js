import loadRuntimeConfig from '@transitops/console/utils/runtime-config';
import { debug } from '@ember/debug';

/**
 * Load Runtime Config Initializer
 *
 * Loads runtime configuration from transitops.config.json before the application boots.
