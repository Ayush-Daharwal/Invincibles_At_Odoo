...
module('Unit | Controller | install', function (hooks) {
    ...
    test('it exposes docs links without installer actions', function (assert) {
        ...
        assert.strictEqual(controller.runningLocallyDocsUrl, 'https://www.transitops.io/docs/platform/quickstart/running-locally');
        assert.strictEqual(controller.cloudDocsUrl, 'https://www.transitops.io/docs/platform/quickstart/deploy-in-cloud');
