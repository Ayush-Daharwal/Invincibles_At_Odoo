...
export default class AiActionPreviewRendererComponent extends Component {
    ...
    @action warnIfMissingRenderer() {
        ...
        warn(`No Transitops AI action preview renderer registered for "${this.registry}". Falling back to the generic action card.`, {
            id: 'transitops-ai.missing-action-preview-renderer',
        });
    }
}
