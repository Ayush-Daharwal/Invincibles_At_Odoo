...
class AiTemporalContext
{
    ...
    public function context(): array
    {
        ...
        return [
            'capability'  => 'transitops.ai.temporal_context',
            'type'        => 'temporal_context',
            'instruction' => 'Use this Transitops temporal context as the source of truth for relative dates. Do not infer today, tomorrow, yesterday, weeks, or months from model/server assumptions when this context is available.',
            'data'        => [
                'timezone'   => $timezone,
