...
class AiAttachmentResolver
{
    ...
    public function contextFor(array $attachments): ?array
    {
        ...
        return [
            'capability'  => 'transitops.ai.attachments',
            'type'        => 'file_attachments',
            'instruction' => 'The user attached these Transitops files to this prompt. Use only the provided metadata and bounded previews. Capability handlers may inspect file IDs for structured parsing.',
            'data'        => [
                'files' => $attachments,
            ],
        ];
