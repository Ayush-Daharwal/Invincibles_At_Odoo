...
Route::prefix(config('storefront.api.routing.prefix', 'storefront'))->namespace('Transitops\Storefront\Http\Controllers')->group(
    function ($router) {
        /*
        |--------------------------------------------------------------------------
        ...
        */
        $router->prefix(config('storefront.api.routing.internal_prefix', 'int'))->group(
            function ($router) {
                ...
                $router->group(
                    ['prefix' => 'v1', 'middleware' => ['transitops.protected']],
                    function ($router) {
                        ...
                        $router->transitopsRoutes('customers');
                        $router->transitopsRoutes('stores');
                        $router->transitopsRoutes('store-hours');
                        $router->transitopsRoutes('store-locations');
                        $router->transitopsRoutes(
                            'products',
                            function ($router, $controller) {
                        ...
                        $router->transitopsRoutes('product-hours');
                        $router->transitopsRoutes('product-variants');
                        $router->transitopsRoutes('product-variant-options');
                        $router->transitopsRoutes('product-addons');
                        $router->transitopsRoutes('product-addon-categories');
                        $router->transitopsRoutes('addon-categories');
                        $router->transitopsRoutes('gateways');
                        $router->transitopsRoutes('notification-channels');
                        $router->transitopsRoutes('reviews');
                        $router->transitopsRoutes('votes');
                        $router->transitopsRoutes('food-trucks');
                        $router->transitopsRoutes('catalogs');
                        $router->transitopsRoutes('catalog-categories');
                        $router->transitopsRoutes('catalog-hours');
                        $router->group(
                            [],
                            function ($router) {
                                $router->group(
