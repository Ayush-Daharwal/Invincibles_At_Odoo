...
namespace Transitops\Storefront\Console\Commands;
...
class SendOrderNotification extends Command
{
    ...
    protected $eventToNotification = [
        'created'          => \Transitops\Storefront\Notifications\StorefrontOrderCreated::class,
        'canceled'         => \Transitops\Storefront\Notifications\StorefrontOrderCanceled::class,
        'completed'        => \Transitops\Storefront\Notifications\StorefrontOrderCompleted::class,
        'driver_assigned'  => \Transitops\Storefront\Notifications\StorefrontOrderDriverAssigned::class,
        'enroute'          => \Transitops\Storefront\Notifications\StorefrontOrderEnroute::class,
        'preparing'        => \Transitops\Storefront\Notifications\StorefrontOrderPreparing::class,
        'ready_for_pickup' => \Transitops\Storefront\Notifications\StorefrontOrderReadyForPickup::class,
        'nearby'           => \Transitops\Storefront\Notifications\StorefrontOrderNearby::class,
    ];
