...
class Cart extends StorefrontModel
{
    ...
    {
        return $this->setConnection(config('transitops.connection.db'))->belongsTo(Contact::class, 'public_id');
    }
     ...
     *
     * @return \Transitops\Models\Storefront\Cart
     */
     ...
     *
     * @param \Transitops\Models\Storefront\Product $product
     * @param int                                  $quantity
     * @param array                                $variants
     * @param array                                $addons
     */
