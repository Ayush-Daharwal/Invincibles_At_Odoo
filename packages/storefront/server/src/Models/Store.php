...
class Store extends StorefrontModel
{
    ...
    {
        return $this->setConnection(config('transitops.connection.db'))->hasMany(Category::class, 'owner_uuid');
    }
    ...
    {
        return data_get($this, 'logo.url', 'https://tro-assets.s3.ap-southeast-1.amazonaws.com/static/image-file-icon.png');
    }
    ...
    {
        return data_get($this, 'backdrop.url', 'https://tro-assets.s3.ap-southeast-1.amazonaws.com/static/default-storefront-backdrop.png');
    }
    ...
    public function createCategory(string $name, string $description = '', ?array $meta = [], ?array $translations = [], ?Category $parent = null, $icon = null, $iconColor = '#000000'): Category
    {
        ...
        return Category::create(
            [
                ...
                'owner_type'     => TransitopsUtils::getMutationType('storefront:store'),
