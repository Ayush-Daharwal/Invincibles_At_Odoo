...
class Customer extends Contact
{
    ...
    {
        return $this->hasMany(Review::class, 'customer_uuid')->where('subject_type', 'Transitops\Storefront\Models\Product');
    }
    ...
    {
        return $this->hasMany(Review::class, 'customer_uuid')->where('subject_type', 'Transitops\Storefront\Models\Store');
    }
    ...
    {
        return $this->hasMany(\Transitops\Models\File::class, 'uploader_uuid')->where('type', 'storefront_review_upload');
    }
