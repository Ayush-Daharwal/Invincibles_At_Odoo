...
use Transitops\Storefront\Http\Resources\FoodTruck as FoodTruckResource;
...
class FoodTruck extends StorefrontModel
{
    ...
    {
        return $this->setConnection(config('transitops.connection.db'))->belongsTo(Vehicle::class, 'vehicle_uuid', 'uuid')->withTrashed();
    }
    ...
    {
        return $this->setConnection(config('transitops.connection.db'))->belongsTo(ServiceArea::class, 'service_area_uuid', 'uuid');
    }
    ...
    {
        return $this->setConnection(config('transitops.connection.db'))->belongsTo(Zone::class, 'zone_uuid', 'uuid');
    }
