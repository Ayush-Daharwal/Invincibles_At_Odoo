...
class Product extends StorefrontModel
{
    ...
    {
        return $this->setConnection(config('transitops.connection.db'))->belongsTo(Category::class);
    }
    ...
    public function getPrimaryImageUrlAttribute()
    {
        ...
        $backup    = 'https://tro-assets.s3.ap-southeast-1.amazonaws.com/static/image-file-icon.png';
