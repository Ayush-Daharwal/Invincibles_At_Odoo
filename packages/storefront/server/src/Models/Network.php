...
class Network extends StorefrontModel
{
    ...
    {
        return $this->setConnection(config('transitops.connection.db'))->belongsTo(User::class);
    }
    ...
    {
        return $this->setConnection(config('transitops.connection.db'))->belongsTo(Company::class);
    }
    ...
    {
        return $this->setConnection(config('transitops.connection.db'))->belongsTo(File::class);
    }
    ...
    {
        return $this->setConnection(config('transitops.connection.db'))->belongsTo(OrderConfig::class);
    }
    ...
    {
        return $this->setConnection(config('transitops.connection.db'))->hasMany(File::class, 'subject_uuid');
    }
    ...
    {
        return $this->setConnection(config('transitops.connection.db'))->hasMany(Invite::class, 'subject_uuid');
    }
    ...
    {
        return $this->setConnection(config('transitops.connection.db'))->hasMany(Category::class, 'owner_uuid')->where(['for' => 'network_category']);
    }
    ...
    {
        // return static::attributeFromCache($this, 'logo.url', 'https://tro-assets.s3.ap-southeast-1.amazonaws.com/static/image-file-icon.png');
        return $this->logo->url ?? 'https://tro-assets.s3.ap-southeast-1.amazonaws.com/static/image-file-icon.png';
    }
    ...
    {
        // return static::attributeFromCache($this, 'backdrop.url', 'https://tro-assets.s3.ap-southeast-1.amazonaws.com/static/default-storefront-backdrop.png');
        return $this->backdrop->url ?? 'https://tro-assets.s3.ap-southeast-1.amazonaws.com/static/default-storefront-backdrop.png';
    }
