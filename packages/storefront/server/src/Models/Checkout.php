...
class Checkout extends StorefrontModel
{
    ...
    {
        return $this->setConnection(config('transitops.connection.db'))->belongsTo(Order::class);
    }
    ...
    {
        return $this->setConnection(config('transitops.connection.db'))->morphTo(__FUNCTION__, 'owner_type', 'owner_uuid')->withoutGlobalScopes();
    }
    ...
    {
        return $this->setConnection(config('transitops.connection.db'))->belongsTo(ServiceQuote::class);
    }
