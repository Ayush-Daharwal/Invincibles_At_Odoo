...
use Transitops\FleetOps\Http\Controllers\Internal\v1\OrderController as TransitopsOrderController;
use Transitops\FleetOps\Models\Order;
use Transitops\Storefront\Http\Resources\Index\Order as StorefrontOrderIndexResource;
use Transitops\Storefront\Http\Resources\Order as StorefrontOrderResource;
...
class OrderController extends TransitopsOrderController
{
    /**
     ...
     * The filter to use.
     *
     * @var \Transitops\Http\Filter\Filter
     */
    public $filter = \Transitops\Storefront\Http\Filter\OrderFilter::class;
