...
class AddonCategoryController extends StorefrontController
{
     ...
     * @throws \Transitops\Exceptions\TransitopsRequestValidationException custom validation exceptions with error details
     */
    public function createRecord(Request $request)
    {
        try {
            ...
            return response()->error($e->getMessage());
        } catch (\Transitops\Exceptions\TransitopsRequestValidationException $e) {
