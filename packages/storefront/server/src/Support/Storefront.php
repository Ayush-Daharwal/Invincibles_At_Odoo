...
namespace Transitops\Storefront\Support;
...
use Transitops\Storefront\Models\Network;
use Transitops\Storefront\Models\NotificationChannel;
use Transitops\Storefront\Models\Product;
use Transitops\Storefront\Models\Store;
use Transitops\Storefront\Notifications\StorefrontOrderAccepted;
use Transitops\Storefront\Notifications\StorefrontOrderCreated;
...
class Storefront
{
    ...
    public static function createStripeCustomerForContact(Contact &$customer)
    {
        $stripeCustomer = \Stripe\Customer::create([
            'description' => 'Customer created in Transitops Storefront',
     ...
     *
     * @param \Transitops\Storefront\Models\Order $order
     *
     * @return \Transitops\Storefront\Models\OrderConfig|null
     */
     ...
     *
     * @return \Transitops\Storefront\Models\OrderConfig
     */
     ...
     *
     * @param Store|\Transitops\FleetOps\Models\Network|string|null $subject
     ...
     * @param Store|\Transitops\FleetOps\Models\Network|string|null $subject
     *
     * @return Store|\Transitops\FleetOps\Models\Network|null
     */
