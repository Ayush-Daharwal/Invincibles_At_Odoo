...
class TestingSeeder extends Seeder
{
    ...
    {
        Schema::connection(config('transitops.connection.db'))->disableForeignKeyConstraints();
        ...
        try {
            ...
            Schema::connection(config('transitops.connection.db'))->enableForeignKeyConstraints();
        }
