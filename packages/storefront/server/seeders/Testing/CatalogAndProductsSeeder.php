...
use Transitops\Storefront\Models\AddonCategory;
use Transitops\Storefront\Models\Catalog;
use Transitops\Storefront\Models\CatalogCategory;
use Transitops\Storefront\Models\CatalogProduct;
use Transitops\Storefront\Models\Product;
use Transitops\Storefront\Models\ProductAddon;
use Transitops\Storefront\Models\ProductAddonCategory;
use Transitops\Storefront\Models\ProductStatus;
use Transitops\Storefront\Models\ProductVariant;
use Transitops\Storefront\Models\ProductVariantOption;
...
class CatalogAndProductsSeeder extends Seeder
{
    ...
    protected function seedStorefront(Company $company): void
    {
        ...
        $store        = $this->createRecord(Store::class, [
            ...
            'phone'             => '+1 555 0100',
            'website'           => 'https://example.test/transitops-market',
            ...
            'meta'              => $this->meta('store:transitops-market'),
        ]);
