import { Widget, ExtensionComponent } from '@transitops/ember-core/contracts';
...
function createStorefrontKeyMetricsWidget() {
    return new Widget({
        ...
        icon: 'store',
        component: new ExtensionComponent('@transitops/storefront-engine', 'widget/storefront-key-metrics'),
...
export function registerWidgets(widgetService) {
    ...
    widgetService.registerWidgets('storefront', [
        new Widget({
            ...
            icon: 'sack-dollar',
            component: new ExtensionComponent('@transitops/storefront-engine', 'widget/kpi-revenue'),
        ...
        new Widget({
            ...
            icon: 'bag-shopping',
            component: new ExtensionComponent('@transitops/storefront-engine', 'widget/kpi-orders'),
            grid_options: { w: 3, h: 4, minW: 3, minH: 4 },
            category: 'KPI Tiles',
            default: true,
        }),
        new Widget({
            ...
            icon: 'receipt',
            component: new ExtensionComponent('@transitops/storefront-engine', 'widget/kpi-aov'),
            grid_options: { w: 3, h: 4, minW: 3, minH: 4 },
            category: 'KPI Tiles',
            default: true,
        }),
        new Widget({
            ...
            icon: 'bolt',
            component: new ExtensionComponent('@transitops/storefront-engine', 'widget/kpi-active-orders'),
            grid_options: { w: 3, h: 4, minW: 3, minH: 4 },
            category: 'KPI Tiles',
            default: true,
        }),
        new Widget({
            ...
            icon: 'circle-check',
            component: new ExtensionComponent('@transitops/storefront-engine', 'widget/kpi-completed-orders'),
            grid_options: { w: 3, h: 4, minW: 3, minH: 4 },
            category: 'KPI Tiles',
            default: true,
        }),
        new Widget({
            ...
            icon: 'users',
            component: new ExtensionComponent('@transitops/storefront-engine', 'widget/kpi-customers'),
            grid_options: { w: 3, h: 4, minW: 3, minH: 4 },
            category: 'KPI Tiles',
            default: true,
        }),
        new Widget({
            ...
            icon: 'cart-shopping',
            component: new ExtensionComponent('@transitops/storefront-engine', 'widget/kpi-cart-conversion'),
            grid_options: { w: 3, h: 4, minW: 3, minH: 4 },
            category: 'KPI Tiles',
            default: true,
        }),
        new Widget({
            ...
            icon: 'ban',
            component: new ExtensionComponent('@transitops/storefront-engine', 'widget/kpi-cancellation-rate'),
            grid_options: { w: 3, h: 4, minW: 3, minH: 4 },
            category: 'KPI Tiles',
            default: true,
        }),
        new Widget({
            ...
            icon: 'chart-line',
            component: new ExtensionComponent('@transitops/storefront-engine', 'widget/revenue-trend'),
        ...
        new Widget({
            ...
            icon: 'ranking-star',
            component: new ExtensionComponent('@transitops/storefront-engine', 'widget/top-products'),
            grid_options: { w: 6, h: 10, minW: 5, minH: 9 },
            category: 'Analytics',
            default: true,
        }),
        new Widget({
            ...
            icon: 'bag-shopping',
            component: new ExtensionComponent('@transitops/storefront-engine', 'widget/orders'),
        ...
        new Widget({
            ...
            icon: 'chart-pie',
            component: new ExtensionComponent('@transitops/storefront-engine', 'widget/customer-insights'),
        ...
        new Widget({
            ...
            icon: 'chart-column',
            component: new ExtensionComponent('@transitops/storefront-engine', 'widget/orders-by-status'),
            grid_options: { w: 6, h: 9, minW: 5, minH: 8 },
            category: 'Analytics',
            default: true,
        }),
        new Widget({
            ...
            icon: 'chart-line',
            component: new ExtensionComponent('@transitops/storefront-engine', 'widget/storefront-metrics'),
        ...
        new Widget({
            ...
            icon: 'users',
            component: new ExtensionComponent('@transitops/storefront-engine', 'widget/customers'),
            grid_options: { w: 12, h: 11, minW: 8, minH: 8 },
            options: { wrapperClass: 'bordered-classic' },
            category: 'Operations',
            default: true,
...
export default {
    setupExtension(app, universe) {
        ...
        registryService.registerRenderableComponent('fleet-ops:component:order:details', new ExtensionComponent('@transitops/storefront-engine', 'storefront-order-summary'));
        registryService.registerRenderableComponent(
            'fleet-ops:template:operations:orders:new:entities-input',
            new ExtensionComponent('@transitops/storefront-engine', 'add-product-as-entity-button')
        );
    },
};
