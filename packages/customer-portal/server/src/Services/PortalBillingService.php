...
namespace Transitops\CustomerPortal\Services;
...
class PortalBillingService
{
    ...
    {
        return class_exists(\Transitops\Ledger\Models\Invoice::class) && class_exists(\Transitops\Ledger\Http\Resources\v1\Invoice::class);
    }
    ...
    public function invoices(int $limit = 100): array
    {
        ...
        return [
            'available' => true,
            'invoices'  => \Transitops\Ledger\Http\Resources\v1\Invoice::collection($invoices)->resolve(),
        ];
    }
    ...
    public function invoice(string $id): array
    {
        ...
        return [
            'available' => true,
            'invoice'   => (new \Transitops\Ledger\Http\Resources\v1\Invoice($invoice))->resolve(),
        ];
    }
    ...
    {
        return \Transitops\Ledger\Models\Invoice::where('company_uuid', session('company'))
