...
import removeBootLoader from '@transitops/console/utils/remove-boot-loader';
...
export default class ApplicationRoute extends Route {
    ...
    /**
     * Add the transitops-portal body class.
     *
     * @memberof ApplicationRoute
     */
    activate() {
        this.theme.setRoutebodyClassNames(['transitops-portal']);
    }
}
