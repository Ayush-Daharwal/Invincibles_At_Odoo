import { MenuItem, ExtensionComponent, Hook, Widget } from '@transitops/ember-core/contracts';
    ...
    setupExtension(app, universe) {
        ...
        menuService.registerSettingsMenuItem(
            new MenuItem({
                ...
                index: 3,
                view: 'index',
                component: new ExtensionComponent('@transitops/customer-portal-engine', 'customer-portal-admin-settings'),
                onClick: (menuItem) => {
                    const router = app.lookup('service:router');
                    if (router) {
    ...
    registerWidgets(widgetService) {
        const widgets = [
            new Widget({
                ...
                icon: 'boxes-packing',
                component: new ExtensionComponent('@transitops/customer-portal-engine', 'widget/active-orders'),
            ...
            new Widget({
                ...
                icon: 'circle-check',
                component: new ExtensionComponent('@transitops/customer-portal-engine', 'widget/completed-orders'),
            ...
            new Widget({
                ...
                component: new ExtensionComponent('@transitops/customer-portal-engine', 'widget/unpaid-invoices'),
            ...
            new Widget({
                ...
                icon: 'headset',
                component: new ExtensionComponent('@transitops/customer-portal-engine', 'widget/open-tickets'),
            ...
            new Widget({
                ...
                component: new ExtensionComponent('@transitops/customer-portal-engine', 'widget/recent-orders'),
            ...
            new Widget({
                ...
                icon: 'bell',
                component: new ExtensionComponent('@transitops/customer-portal-engine', 'widget/pending-actions'),
