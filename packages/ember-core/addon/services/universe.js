...
export default class UniverseService extends Service.extend(Evented) {
     ...
     * @example
     * universe.onEngineLoaded('@transitops/fleetops-engine', (engineInstance) => {
     ...
     * if (universe.extensionManager.isEngineLoaded('@transitops/fleetops-engine')) {
     *     const engine = universe.extensionManager.getEngineInstance('@transitops/fleetops-engine');
     *     doSomething(engine);
     * } else {
     *     universe.onEngineLoaded('@transitops/fleetops-engine', (engine) => {
     *         doSomething(engine);
     *     });
     * }
     *
     * // With this simpler pattern:
     * universe.whenEngineLoaded('@transitops/fleetops-engine', (engine) => {
     *     doSomething(engine);
     * });
     */
     ...
     *     new ExtensionComponent('@transitops/storefront-engine', 'storefront-order-summary')
     * );
     */
     ...
     * import TemplateHelper from '@transitops/ember-core/contracts/template-helper';
     * await universe.registerHelper(
     *     'calculate-delivery-fee',
     *     new TemplateHelper('@transitops/storefront-engine', 'helpers/calculate-delivery-fee')
     * );
     */
