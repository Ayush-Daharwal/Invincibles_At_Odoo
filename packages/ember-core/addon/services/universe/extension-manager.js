...
import loadInstalledExtensions from '@transitops/ember-core/utils/load-installed-extensions';
import mapEngines from '@transitops/ember-core/utils/map-engines';
import config from 'ember-get-config';
import { getExtensionLoader } from '@transitops/console/extensions';
...
export default class ExtensionManagerService extends Service.extend(Evented) {
     ...
     * @param {String} engineName Engine name (e.g., '@transitops/fleetops-engine')
     ...
     * @example
     * // Simple usage
     * extensionManager.whenEngineLoaded('@transitops/fleetops-engine', (fleetopsEngine) => {
     *     console.log('FleetOps loaded!', fleetopsEngine);
     * });
     *
     * @example
     * // With all parameters
     * extensionManager.whenEngineLoaded('@transitops/customer-portal-engine', (portalEngine, universe, app) => {
