...
export default class LegacyUniverseService extends Service.extend(Evented) {
    @service router;
    @service intl;
     ...
     *
     * @example
     * // Transitions to the 'management.fleets.index.new' route within the '@transitops/fleet-ops' engine.
     * this.transitionToEngineRoute('@transitops/fleet-ops', 'management.fleets.index.new');
     */
     ...
     * _mountPathFromEngineName('@transitops/some-engine');
     */
