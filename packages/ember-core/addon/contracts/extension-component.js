 ...
 * @example
 * // Simple usage
 * new ExtensionComponent('@transitops/fleetops-engine', 'components/admin/navigator-app')
 *
 * @example
 * // With options
 * new ExtensionComponent('@transitops/fleetops-engine', {
 ...
 * new ExtensionComponent('@transitops/fleetops-engine', 'components/widget/metrics')
...
export default class ExtensionComponent extends BaseContract {
     ...
     *
     * @constructor
     * @param {String} engineName The name of the engine (e.g., '@transitops/fleetops-engine')
