 ...
 *   icon: 'route',
 *   priority: 0,
 *   component: { engine: '@transitops/fleetops-engine', path: 'components/admin/navigator-app' }
 * })
 *
 * @example
 * // Menu item with component
 * new MenuItem('Settings')
 *   .withComponent(new ExtensionComponent('@transitops/my-engine', 'components/settings'))
