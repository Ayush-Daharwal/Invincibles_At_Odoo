 ...
 *   .withIcon('truck')
 *   .withComponent(new ExtensionComponent('@transitops/fleetops-engine', 'components/widget/metrics'))
 ...
 *   icon: 'truck',
 *   component: new ExtensionComponent('@transitops/fleetops-engine', 'components/widget/metrics'),
