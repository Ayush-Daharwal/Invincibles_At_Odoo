...
namespace Transitops\Vroom\Http\Controllers;

use Transitops\Http\Controllers\Controller;
use Transitops\Vroom\Exceptions\VroomApiException;
use Transitops\Vroom\Support\Utils;
use Transitops\Vroom\Support\Vroom;
...
class VroomController extends Controller
{
    ...
    public function saveSettings(Request $request)
    {
        ...
        \Transitops\Models\Setting::configureCompany('vroom', $settings);
    ...
    public function saveAdminSettings(Request $request)
    {
        ...
        \Transitops\Models\Setting::configure('vroom', $settings);
