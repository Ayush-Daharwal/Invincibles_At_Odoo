    ...
    setupExtension(app, universe) {
        ...
        menuService.registerMenuItem(
            ...
            new MenuItem({
                ...
                type: 'link',
                wrapperClass: 'hidden',
                component: new ExtensionComponent('@transitops/ledger-engine', 'customer-invoice'),
                onClick: (menuItem) => {
        ...
        menuService.registerMenuItem(
            ...
            new MenuItem({
                ...
                component: new ExtensionComponent('@transitops/ledger-engine', 'order-invoice'),
                icon: 'file-invoice-dollar',
                slug: 'invoice',
            })
        );
    ...
    registerWidgets(widgetService) {
        const widgets = [
            new Widget({
                ...
                icon: 'sack-dollar',
                component: new ExtensionComponent('@transitops/ledger-engine', 'widget/kpi-revenue'),
            ...
            new Widget({
                ...
                icon: 'receipt',
                component: new ExtensionComponent('@transitops/ledger-engine', 'widget/kpi-expenses'),
                grid_options: { w: 3, h: 4, minW: 3, minH: 4 },
                category: 'KPI Tiles',
                default: true,
            }),
            new Widget({
                ...
                icon: 'chart-line',
                component: new ExtensionComponent('@transitops/ledger-engine', 'widget/kpi-net-income'),
                grid_options: { w: 3, h: 4, minW: 3, minH: 4 },
                category: 'KPI Tiles',
                default: true,
            }),
            new Widget({
                ...
                icon: 'file-invoice-dollar',
                component: new ExtensionComponent('@transitops/ledger-engine', 'widget/kpi-outstanding-ar'),
                grid_options: { w: 3, h: 4, minW: 3, minH: 4 },
                category: 'KPI Tiles',
                default: true,
            }),
            new Widget({
                ...
                icon: 'clock',
                component: new ExtensionComponent('@transitops/ledger-engine', 'widget/kpi-overdue-ar'),
                grid_options: { w: 3, h: 4, minW: 3, minH: 4 },
                category: 'KPI Tiles',
                default: true,
            }),
            new Widget({
                ...
                component: new ExtensionComponent('@transitops/ledger-engine', 'widget/kpi-open-invoices'),
                grid_options: { w: 3, h: 4, minW: 3, minH: 4 },
                category: 'KPI Tiles',
                default: true,
            }),
            new Widget({
                ...
                icon: 'wallet',
                component: new ExtensionComponent('@transitops/ledger-engine', 'widget/kpi-wallet-balance'),
                grid_options: { w: 3, h: 4, minW: 3, minH: 4 },
                category: 'KPI Tiles',
                default: true,
            }),
            new Widget({
                ...
                icon: 'wallet',
                component: new ExtensionComponent('@transitops/ledger-engine', 'widget/kpi-active-wallets'),
                grid_options: { w: 3, h: 4, minW: 3, minH: 4 },
                category: 'KPI Tiles',
                default: true,
            }),
            ...
            new Widget({
                ...
                icon: 'chart-line',
                component: new ExtensionComponent('@transitops/ledger-engine', 'widget/revenue-trend'),
            ...
            new Widget({
                ...
                icon: 'money-bill-transfer',
                component: new ExtensionComponent('@transitops/ledger-engine', 'widget/cash-flow-summary'),
                grid_options: { w: 6, h: 9, minW: 5, minH: 8 },
                category: 'Analytics',
                default: true,
            }),
            new Widget({
                ...
                icon: 'file-invoice-dollar',
                component: new ExtensionComponent('@transitops/ledger-engine', 'widget/invoice-status'),
            ...
            new Widget({
                ...
                icon: 'clock',
                component: new ExtensionComponent('@transitops/ledger-engine', 'widget/ar-aging-summary'),
                grid_options: { w: 4, h: 8, minW: 4, minH: 7 },
                category: 'Operations',
                default: true,
            }),
            new Widget({
                ...
                icon: 'wallet',
                component: new ExtensionComponent('@transitops/ledger-engine', 'widget/wallet-balances'),
                grid_options: { w: 4, h: 8, minW: 4, minH: 7 },
                category: 'Operations',
                default: true,
            }),
            new Widget({
                ...
                icon: 'book',
                component: new ExtensionComponent('@transitops/ledger-engine', 'widget/activity-feed'),
            ...
            new Widget({
                ...
                icon: 'file-lines',
                component: new ExtensionComponent('@transitops/ledger-engine', 'widget/report-shortcuts'),
            ...
            new Widget({
                ...
                icon: 'gauge-high',
                component: new ExtensionComponent('@transitops/ledger-engine', 'widget/overview'),
            ...
            new Widget({
                ...
                icon: 'chart-line',
                component: new ExtensionComponent('@transitops/ledger-engine', 'widget/revenue-chart'),
            ...
            new Widget({
                ...
                icon: 'file-invoice-dollar',
                component: new ExtensionComponent('@transitops/ledger-engine', 'widget/invoice-summary'),
