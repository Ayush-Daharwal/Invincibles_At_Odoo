...
export function initialize(appInstance) {
    ...
    templateBuilder.registerResourceTypes([
        {
            label: 'Invoice',
            value: 'Transitops\\Ledger\\Models\\Invoice',
            icon: 'file-invoice-dollar',
        },
        {
            label: 'Transaction',
            value: 'Transitops\\Ledger\\Models\\Transaction',
            icon: 'money-bill-transfer',
        },
        {
            label: 'Account',
            value: 'Transitops\\Ledger\\Models\\Account',
            icon: 'building-columns',
        },
        {
            label: 'Wallet',
            value: 'Transitops\\Ledger\\Models\\Wallet',
            icon: 'wallet',
        },
    ]);
}
