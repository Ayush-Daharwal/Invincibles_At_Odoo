...
namespace Transitops\Ledger\Seeders\Testing;
...
use Transitops\Seeders\Concerns\ResolvesSeedCompany;
...
class TalerDemoSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $this->command?->info('[Ledger/Taler] Hosted sandbox gateway: backend_url=https://merchant.taler.transitops.io, instance_id=default, and the hosted token.');
    }
    ...
    private function seedCoreTransaction(Company $company, Carbon $now): void
    {
        ...
        DB::table('transactions')->updateOrInsert(
            ...
            $this->columns('transactions', [
                ...
                'subject_type'           => 'Transitops\\FleetOps\\Models\\Order',
                'context_uuid'           => $this->ids['purchase_rate'],
                'context_type'           => 'Transitops\\FleetOps\\Models\\PurchaseRate',
    ...
    private function seedFleetOpsTrackingFixture(Company $company, Carbon $now): void
    {
        ...
        DB::table('tracking_numbers')->updateOrInsert(
            ...
            [
                ...
                'owner_type'      => 'Transitops\\FleetOps\\Models\\Order',
