...
namespace Transitops\Ledger\Seeders;
 ...
 * LedgerSeeder
 *
 * Seeds the default system chart of accounts for every company in the Transitops
 ...
 *
 * Usage:
 *   php artisan db:seed --class="Transitops\Ledger\Seeds\LedgerSeeder"
 *
...
class LedgerSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $companyModel = app('Transitops\Models\Company');
