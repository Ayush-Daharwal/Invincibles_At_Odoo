...
namespace Transitops\Ledger\Gateways;

use Transitops\Ledger\DTO\GatewayResponse;
use Transitops\Ledger\DTO\PurchaseRequest;
use Transitops\Ledger\DTO\RefundRequest;
use Transitops\Ledger\Exceptions\WebhookSignatureException;
 ...
 *
 * Amount encoding:
 *   Transitops stores all monetary values as integers in the smallest currency
...
class TalerDriver extends AbstractGatewayDriver
{
     ...
     * {@inheritdoc}
     *
     * Returns the configuration schema rendered dynamically by the Transitops
     ...
     *
     * The Transitops invoice UUID is embedded in the order's contract terms
    ...
    public function handleWebhook(Request $request): GatewayResponse
    {
        ...
        // to locate and mark the Transitops invoice as paid.
        ...
        // Parse the deposit_total amount back to Transitops integer cents.
    ...
    /**
     * Convert a Transitops integer amount (smallest currency unit) to a Taler
