...
namespace Transitops\Ledger\Http\Controllers\Internal\v1;

use Transitops\Ledger\Http\Controllers\LedgerResourceController;
use Transitops\Ledger\Http\Resources\v1\Invoice as InvoiceResource;
use Transitops\Ledger\Http\Resources\v1\Transaction as TransactionResource;
use Transitops\Ledger\Models\Invoice;
use Transitops\Ledger\Models\InvoiceItem;
use Transitops\Ledger\Models\Transaction;
...
class InvoiceController extends LedgerResourceController
{
    ...
    public function createFromOrder(Request $request): InvoiceResource
    {
        ...
        $order = \Transitops\FleetOps\Models\Order::where('company_uuid', session('company'))
     ...
     * not affected.
     */
    private function normaliseTemplateContextType(\Transitops\Models\Template $template): \Transitops\Models\Template
    {
