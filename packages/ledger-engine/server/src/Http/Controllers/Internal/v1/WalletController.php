...
use Transitops\Http\Resources\TransitopsResourceCollection;
...
use Transitops\Ledger\Http\Resources\v1\Wallet as WalletResource;
use Transitops\Ledger\Models\Transaction;
use Transitops\Ledger\Models\Wallet;
...
class WalletController extends LedgerResourceController
{
     ...
     */
    public function getTransactions(string $id, Request $request): AnonymousResourceCollection|TransitopsResourceCollection
    {
        $wallet = $this->resolveWallet($id);
