...
namespace Transitops\Ledger\Http\Controllers\Public;

use Transitops\Ledger\DTO\GatewayResponse;
use Transitops\Ledger\DTO\PurchaseRequest;
use Transitops\Ledger\Gateways\CashDriver;
use Transitops\Ledger\Gateways\StripeDriver;
use Transitops\Ledger\Http\Resources\v1\Gateway as GatewayResource;
use Transitops\Ledger\Http\Resources\v1\Invoice as InvoiceResource;
use Transitops\Ledger\Models\Gateway;
...
class PublicInvoiceController extends Controller
{
    ...
    private function initiateStripeCheckout(StripeDriver $driver, Invoice $invoice, Request $request): JsonResponse
    {
        ...
        // Utils::consoleUrl reads transitops.console.host (CONSOLE_HOST env var) so
