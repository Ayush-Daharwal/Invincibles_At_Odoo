import { MenuItem, Widget, ExtensionComponent } from '@transitops/ember-core/contracts';
...
export default {
    setupExtension(app, universe) {
        ...
        menuService.registerAdminMenuPanel(
            ...
            [
                new MenuItem({
                    title: 'Routing',
                    icon: 'route',
                    component: new ExtensionComponent('@transitops/fleetops-engine', 'admin/routing-settings'),
                }),
                new MenuItem({
                    title: 'Map',
                    icon: 'map',
                    component: new ExtensionComponent('@transitops/fleetops-engine', 'admin/map-settings'),
                }),
                new MenuItem({
                    title: 'Navigator App',
                    icon: 'location-arrow',
                    component: new ExtensionComponent('@transitops/fleetops-engine', 'admin/navigator-app'),
                }),
            ],
            {
                slug: 'fleet-ops',
        ...
        menuService.registerMenuItem(
            ...
            new MenuItem({
                ...
                component: new ExtensionComponent('@transitops/fleetops-engine', 'order-tracking-lookup'),
                onClick: (menuItem) => {
        ...
        registryService.registerRenderableComponent('ai:action-preview:fleet-ops.create_order', new ExtensionComponent('@transitops/fleetops-engine', 'ai/create-order-preview'));

        // // Register console home guidance
        // this.registerHomeComponents(registryService);

        // Setup customer portal
        const isCustomerPortalInstalled = universe.extensionManager.isInstalled('@transitops/customer-portal-engine');
        if (isCustomerPortalInstalled) {
            universe.whenEngineLoaded('@transitops/customer-portal-engine', () => {
                universe.extensionManager.ensureEngineLoaded('@transitops/fleetops-engine');
            });
        }
    },
    ...
    registerWidgets(widgetService) {
        const widgets = [
            ...
            new Widget({
                ...
                icon: 'truck',
                component: new ExtensionComponent('@transitops/fleetops-engine', 'widget/fleet-ops-key-metrics'),
            ...
            new Widget({
                ...
                icon: 'sack-dollar',
                component: new ExtensionComponent('@transitops/fleetops-engine', 'widget/kpi-earnings'),
            ...
            new Widget({
                ...
                icon: 'receipt',
                component: new ExtensionComponent('@transitops/fleetops-engine', 'widget/kpi-aov'),
                grid_options: { w: 3, h: 4, minW: 3, minH: 4 },
                category: 'KPI Tiles',
                default: true,
            }),
            new Widget({
                ...
                icon: 'route',
                component: new ExtensionComponent('@transitops/fleetops-engine', 'widget/kpi-distance'),
                grid_options: { w: 3, h: 4, minW: 3, minH: 4 },
                category: 'KPI Tiles',
                default: false,
            }),
            new Widget({
                ...
                icon: 'bolt',
                component: new ExtensionComponent('@transitops/fleetops-engine', 'widget/kpi-active-orders'),
                grid_options: { w: 3, h: 4, minW: 3, minH: 4 },
                category: 'KPI Tiles',
                default: true,
            }),
            new Widget({
                ...
                icon: 'id-card',
                component: new ExtensionComponent('@transitops/fleetops-engine', 'widget/kpi-drivers-online'),
                grid_options: { w: 3, h: 4, minW: 3, minH: 4 },
                category: 'KPI Tiles',
                default: true,
            }),
            new Widget({
                ...
                component: new ExtensionComponent('@transitops/fleetops-engine', 'widget/kpi-open-issues'),
                grid_options: { w: 3, h: 4, minW: 3, minH: 4 },
                category: 'KPI Tiles',
                default: false,
            }),
            ...
            new Widget({
                ...
                icon: 'wave-pulse',
                component: new ExtensionComponent('@transitops/fleetops-engine', 'widget/operations-pulse'),
            ...
            new Widget({
                ...
                component: new ExtensionComponent('@transitops/fleetops-engine', 'widget/live-fleet'),
            ...
            new Widget({
                ...
                icon: 'chart-line',
                component: new ExtensionComponent('@transitops/fleetops-engine', 'widget/revenue-trend'),
            ...
            new Widget({
                ...
                icon: 'chart-column',
                component: new ExtensionComponent('@transitops/fleetops-engine', 'widget/orders-by-status'),
                grid_options: { w: 6, h: 6, minW: 5, minH: 5 },
                category: 'Analytics',
                default: false,
            }),
            new Widget({
                ...
                icon: 'clock',
                component: new ExtensionComponent('@transitops/fleetops-engine', 'widget/on-time-delivery'),
                grid_options: { w: 3, h: 4, minW: 3, minH: 4 },
                category: 'Analytics',
                default: false,
            }),
            new Widget({
                ...
                icon: 'medal',
                component: new ExtensionComponent('@transitops/fleetops-engine', 'widget/top-drivers'),
                grid_options: { w: 6, h: 6, minW: 5, minH: 5 },
                category: 'Analytics',
                default: true,
            }),
            new Widget({
                ...
                icon: 'gas-pump',
                component: new ExtensionComponent('@transitops/fleetops-engine', 'widget/fuel-efficiency'),
                grid_options: { w: 6, h: 6, minW: 5, minH: 5 },
                category: 'Analytics',
                default: false,
            }),
            new Widget({
                ...
                icon: 'gas-pump',
                component: new ExtensionComponent('@transitops/fleetops-engine', 'widget/fuel-providers'),
            ...
            new Widget({
                ...
                icon: 'triangle-exclamation',
                component: new ExtensionComponent('@transitops/fleetops-engine', 'widget/issues-insights'),
                grid_options: { w: 6, h: 6, minW: 5, minH: 5 },
                category: 'Analytics',
                default: false,
            }),
            new Widget({
                ...
                icon: 'wrench',
                component: new ExtensionComponent('@transitops/fleetops-engine', 'widget/maintenance-overview'),
                grid_options: { w: 6, h: 6, minW: 5, minH: 5 },
                category: 'Analytics',
                default: true,
            }),
            new Widget({
                ...
                component: new ExtensionComponent('@transitops/fleetops-engine', 'widget/geofence-violations'),
                grid_options: { w: 6, h: 6, minW: 5, minH: 5 },
                category: 'Analytics',
                default: false,
            }),
    ...
    registerHomeComponents(registryService) {
        registryService.registerRenderableComponent('console:home:before-dashboard', new ExtensionComponent('@transitops/fleetops-engine', 'home/getting-started-guidance'));
    },
