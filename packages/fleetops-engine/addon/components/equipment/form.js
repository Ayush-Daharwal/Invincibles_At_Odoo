...
const TYPE_TO_MODEL = {
    ...
    'Transitops\\FleetOps\\Models\\Vehicle': 'vehicle',
    'Transitops\\FleetOps\\Models\\Driver': 'driver',
    'fleet-ops:equipment': 'equipment',
};

const TYPE_TO_OPTION_VALUE = {
    'Transitops\\FleetOps\\Models\\Vehicle': 'fleet-ops:vehicle',
    'Transitops\\FleetOps\\Models\\Driver': 'fleet-ops:driver',
};
...
export default class EquipmentFormComponent extends Component {
    ...
    /**
     * Handles photo upload using the Transitops fetch service upload pattern.
     */
