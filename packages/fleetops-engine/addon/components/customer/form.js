...
export default class CustomerFormComponent extends Component {
    ...
    @tracked userAccountActionButtons = [
        {
            ...
            onClick: async () => {
                ...
                await this.extensionManager.ensureEngineLoaded('@transitops/iam-engine');
    ...
    get showWelcomeEmailOption() {
        return this.args.resource?.isNew && this.extensionManager.isInstalled('@transitops/customer-portal-engine');
    }
