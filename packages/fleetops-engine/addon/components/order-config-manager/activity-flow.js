...
import generateUUID from '@transitops/ember-core/utils/generate-uuid';
import inlineTask from '@transitops/ember-core/utils/inline-task';
import createFlowActivity from '../../utils/create-flow-activity';
import contextComponentCallback from '@transitops/ember-core/utils/context-component-callback';
...
export default class OrderConfigManagerActivityFlowComponent extends Component {
    ...
    initializeActivityJointModel() {
        joint.shapes.transitops = {};
        joint.shapes.transitops.Activity = joint.shapes.standard.Rectangle.define(
            'transitops.Activity',
            {
                attrs: {
    ...
    createActivityNode(activity, positionals = {}) {
        ...
        const activityNode = new joint.shapes.transitops.Activity({
            position: { x, y },
            size: { width, height },
            attrs: {
                pill: {
