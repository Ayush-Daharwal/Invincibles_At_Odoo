 ...
 *   2. Map     — map file columns to Transitops order fields (grouped by section)
...
export default class OrchestratorImportComponent extends Component {
    ...
    @action downloadTemplate() {
        ...
        window.open('https://tro-assets.s3.ap-southeast-1.amazonaws.com/import-templates/Transitops_Order_Import_Template.xlsx');
    }
}
