import toPowerSelectGroups from '@transitops/ember-ui/utils/to-power-select-groups';
...
export const vendorTypes = [
    ...
    { label: 'Integrated Vendor', value: 'integrated_vendor', description: 'Vendor with native API integration into Transitops' },
