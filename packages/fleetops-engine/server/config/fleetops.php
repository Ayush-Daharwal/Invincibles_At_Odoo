...
return [
    ...
    */
    ...
    | the optional `transitops/vroom` extension to be installed. When the
    | extension IS installed its `vroom.base_uri` config key takes precedence.
    |
    | API key resolution order:
    |   1. Company-level setting written by the transitops/vroom extension UI
    ...
    */
    'navigator' => [
        ...
        'app_identifier'           => env('NAVIGATOR_APP_IDENTIFIER', 'io.transitops.navigator'),
    ],
