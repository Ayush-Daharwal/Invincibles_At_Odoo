...
namespace Transitops\FleetOps\Seeders\Testing\Concerns;

use Transitops\FleetOps\Models\ServiceArea;
use Transitops\FleetOps\Models\Zone;
use Transitops\LaravelMysqlSpatial\Types\LineString;
use Transitops\LaravelMysqlSpatial\Types\MultiPolygon;
use Transitops\LaravelMysqlSpatial\Types\Point;
use Transitops\LaravelMysqlSpatial\Types\Polygon;
...
trait SeedsTestingData
{
    ...
    protected function prepareCompany(): ?Company
    {
        ...
        if (!$company) {
            $this->command?->error('No company found. Create a Transitops company before running FleetOps testing seeders.');
