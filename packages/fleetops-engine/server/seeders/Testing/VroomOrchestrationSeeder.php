...
/**
 * Explicit test-data seeder. Kept below server/seeders/Testing so transitops:seed
 * does not auto-discover it during deploys.
 *
 * Run with:
 * php artisan db:seed --class="Transitops\\FleetOps\\Seeders\\Testing\\VroomOrchestrationSeeder"
 */
class VroomOrchestrationSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        if (!$company) {
            $this->command?->error('No company found. Create a Transitops company before running the VROOM orchestration seeder.');
