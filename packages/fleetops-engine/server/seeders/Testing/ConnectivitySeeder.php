...
namespace Transitops\FleetOps\Seeders\Testing;

use Transitops\FleetOps\Models\Device;
use Transitops\FleetOps\Models\DeviceEvent;
use Transitops\FleetOps\Models\Driver;
use Transitops\FleetOps\Models\GeofenceEventLog;
...
use Transitops\FleetOps\Seeders\Testing\Concerns\SeedsTestingData;
...
class ConnectivitySeeder extends Seeder
{
    ...
    protected function seedDevices(Company $company, array $telematics): array
    {
        ...
        $devices        = [
            'device_van_central' => ['CEN-01 OBD', 'OBD-II', 'Transitops Labs', 'DEV-CEN-001', 'telematic_samsara', $vehicleCentral, 1.2821, 103.8510, true, 'online'],
            'device_van_east'    => ['EAS-01 Reefer', 'ColdChain-GW', 'Transitops Labs', 'DEV-EAST-001', 'telematic_calculated', $vehicleEast, 1.3522, 103.9442, true, 'online'],
        ];
