...
return new class extends Migration {
    public function up(): void
    {
        ...
        if (Schema::hasColumn('devices', 'vehicle_uuid')) {
            ...
            $vehicleModel = 'Transitops\\\\FleetOps\\\\Models\\\\Vehicle';
            ...
            if ($this->isMySql()) {
                ...
                $vehicleModelPg = 'Transitops\\FleetOps\\Models\\Vehicle';
                DB::statement("
                    UPDATE devices
    ...
    public function down(): void
    {
        ...
        $vehicleModelSqlMy = 'Transitops\\\\FleetOps\\\\Models\\\\Vehicle';
        $vehicleModelSqlPg = 'Transitops\\FleetOps\\Models\\Vehicle';
