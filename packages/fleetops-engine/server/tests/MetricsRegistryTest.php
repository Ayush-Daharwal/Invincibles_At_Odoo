...
use Transitops\FleetOps\Support\Metrics\AbstractMetric;
use Transitops\FleetOps\Support\Metrics\OrdersInProgressMetric;
use Transitops\FleetOps\Support\Metrics\Registry;
use Transitops\FleetOps\Support\Metrics\TotalTimeTraveledMetric;
...
test('active revenue query excludes inactive financial and operational lifecycle records', function () {
    ...
    expect(Transitops\FleetOps\Support\Metrics\ActiveRevenueQuery::ACTIVE_STATUSES)->toBe([Transaction::STATUS_SUCCESS]);
    expect(Transitops\FleetOps\Support\Metrics\ActiveRevenueQuery::ACTIVE_STATUSES)->not->toContain('completed');
    expect(Transitops\FleetOps\Support\Metrics\ActiveRevenueQuery::ACTIVE_STATUSES)->not->toContain('paid');
});

test('active revenue query treats invoice status as invalidation only', function () {
    $inactiveInvoiceStatuses = Transitops\FleetOps\Support\Metrics\ActiveRevenueQuery::INACTIVE_INVOICE_STATUSES;
