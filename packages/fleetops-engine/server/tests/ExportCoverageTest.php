...
use Transitops\FleetOps\Exports\DeviceExport;
use Transitops\FleetOps\Exports\MaintenanceExport;
use Transitops\FleetOps\Exports\MaintenanceScheduleExport;
use Transitops\FleetOps\Exports\VehicleExport;
use Transitops\FleetOps\Exports\WorkOrderExport;
...
test('resources with visible export actions have backend export routes', function () {
    ...
    foreach (['devices', 'sensors', 'telematics', 'maintenance-schedules', 'work-orders', 'maintenances', 'equipment', 'parts'] as $resource) {
        expect($routes)->toContain("\$router->transitopsRoutes('{$resource}'");
    }
