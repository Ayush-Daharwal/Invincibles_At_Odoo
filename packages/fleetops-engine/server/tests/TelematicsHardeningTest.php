...
use Transitops\FleetOps\Contracts\TelematicProviderDescriptor;
use Transitops\FleetOps\Models\Telematic;
use Transitops\FleetOps\Support\Telematics\Providers\AfaqyProvider;
use Transitops\FleetOps\Support\Telematics\Providers\FlespiProvider;
use Transitops\FleetOps\Support\Telematics\Providers\GeotabProvider;
use Transitops\FleetOps\Support\Telematics\Providers\SafeeProvider;
use Transitops\FleetOps\Support\Telematics\Providers\SamsaraProvider;
...
test('device event mark processed action is routed and company scoped', function () {
    ...
    expect($routes)
        ->toContain("\$router->transitopsRoutes('device-events', function")
...
test('device attachment morph types are normalized and legacy aliases are tolerated', function () {
    ...
    expect($serviceProvider)
        ...
        ->toContain("'Transitops\\\\Models\\\\Vehicle'   => \\Transitops\\FleetOps\\Models\\Vehicle::class")
        ->toContain("'\\\\Transitops\\\\Models\\\\Vehicle' => \\Transitops\\FleetOps\\Models\\Vehicle::class");
});
