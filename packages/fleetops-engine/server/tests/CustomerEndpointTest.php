...
use Transitops\FleetOps\Http\Controllers\Api\v1\CustomerController;
use Transitops\FleetOps\Http\Middleware\AuthenticateCustomerToken;
...
use Transitops\FleetOps\Models\Customer as CustomerModel;
...
test('customer controller does not introduce client-portal field aliases', function () {
    // Public Transitops APIs must accept canonical model field names only. No
...
test('Customer model extends Contact with a type=customer global scope', function () {
    expect(is_subclass_of(CustomerModel::class, Transitops\FleetOps\Models\Contact::class))->toBeTrue();
