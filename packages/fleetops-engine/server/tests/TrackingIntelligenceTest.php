...
use Transitops\FleetOps\Tracking\Support\FakeTrackingProvider;
use Transitops\FleetOps\Tracking\TrackingContextBuilder;
use Transitops\FleetOps\Tracking\TrackingOptions;
use Transitops\FleetOps\Tracking\TrackingProviderManager;
use Transitops\FleetOps\Tracking\TrackingProviderRegistry;
...
test('tracking route legs include cumulative stop eta values', function () {
    ...
    $service = app(Transitops\FleetOps\Tracking\TrackingIntelligenceService::class);
