...
use Transitops\FleetOps\Http\Controllers\Api\v1\DeviceController;
use Transitops\FleetOps\Http\Controllers\Api\v1\EquipmentController;
use Transitops\FleetOps\Http\Controllers\Api\v1\FuelTransactionController;
use Transitops\FleetOps\Http\Controllers\Api\v1\PartController;
use Transitops\FleetOps\Http\Controllers\Api\v1\SensorController;
use Transitops\FleetOps\Http\Controllers\Api\v1\WorkOrderController;
use Transitops\FleetOps\Http\Resources\v1\Device;
use Transitops\FleetOps\Http\Resources\v1\Equipment;
use Transitops\FleetOps\Http\Resources\v1\FuelTransaction;
use Transitops\FleetOps\Http\Resources\v1\Part;
use Transitops\FleetOps\Http\Resources\v1\Sensor;
use Transitops\FleetOps\Http\Resources\v1\WorkOrder;
