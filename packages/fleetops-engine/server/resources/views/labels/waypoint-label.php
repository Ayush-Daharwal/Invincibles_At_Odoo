...
<head>
    ...
    <title><?php echo e($company->name ?? ($waypoint->internal_id ?? $waypoint->public_id)); ?> Waypoint Label</title>
</head>
    ...
    <div style="width: 420px; border: 2px #414141 solid; margin: auto;">
        <div class="group" style="border-bottom: 1px #414141 solid; overflow: hidden;">
            ...
            <div style="margin-top: 10px;">
                <span style="padding-left: 10px; font-size: 18px; font-weight: bold;"><?php echo e($company->name); ?></span>
            </div>
        </div>
                            ...
                            <div class="line">
                                <strong>
                                    ...
                                    if (data_get($entity, 'name')) {
                                        echo e(data_get($entity, 'name') . ' - ' . data_get($entity, 'internal_id', ''));
                                    } else {
                                        echo e('ITEM - ' . data_get($entity, 'internal_id', ''));
                                    }
                            ?>
                                </strong>
                            </div>
