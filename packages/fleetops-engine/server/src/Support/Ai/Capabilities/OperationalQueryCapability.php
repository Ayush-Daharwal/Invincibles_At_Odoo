...
class OperationalQueryCapability extends AbstractFleetOpsAICapability
{
    ...
    public function resolve(AiTask $task): array
    {
        ...
        return [
            'authorized'   => true,
            'query_engine' => 'transitops_ai_allowlisted_operational_query',
            'instruction'  => 'Answer only from these executed Transitops query summaries. If a requested metric is missing or empty, say that Transitops did not return enough data for that specific metric.',
