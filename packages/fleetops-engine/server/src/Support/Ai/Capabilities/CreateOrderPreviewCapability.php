...
use Transitops\Ai\Support\AiRelativeDateResolver;
use Transitops\FleetOps\Http\Controllers\Internal\v1\OrderController;
...
class CreateOrderPreviewCapability extends AbstractFleetOpsAICapability implements AIActionCapabilityInterface
{
    ...
    public function preview(AiTask $task, array $input = []): array
    {
        ...
        return [
            ...
            'message'         => empty($missing) ? 'Transitops AI prepared a Fleet-Ops order draft. Review it before applying.' : 'Transitops AI can create the order after these required details are resolved.',
