    ...
    protected function steps(): array
    {
        ...
        return [
            [
                ...
                'docs_url'    => 'https://www.transitops.io/docs/fleet-ops/drivers',
            ],
            [
                'key'         => 'create_order',
                ...
                'docs_url'    => 'https://www.transitops.io/docs/fleet-ops/orders',
            ],
            [
                'key'         => 'assign_driver',
                ...
                'docs_url'    => 'https://www.transitops.io/docs/fleet-ops/dispatch',
            ],
            [
                'key'         => 'update_activity',
                ...
                'icon'        => 'route',
                'route'       => 'console.fleet-ops.operations.orders.index',
                'docs_url'    => 'https://www.transitops.io/docs/fleet-ops/tracking',
            ],
        ];
    }
    ...
    protected function recommendations(): array
    {
        return [
            [
                ...
                'icon'        => 'route',
                'accent'      => 'blue',
                'docs_url'    => 'https://www.transitops.io/docs/fleet-ops/orchestrator',
            ],
            [
                'key'         => 'live_fleet',
                ...
                'accent'      => 'green',
                'docs_url'    => 'https://www.transitops.io/docs/fleet-ops/live-map',
            ],
            [
                'key'         => 'service_rates',
                'title'       => 'Service Rates',
                ...
                'icon'        => 'receipt',
                'accent'      => 'amber',
                'docs_url'    => 'https://www.transitops.io/docs/fleet-ops/service-rates',
            ],
            [
                'key'         => 'customer_portal',
                ...
                'icon'        => 'store',
                'accent'      => 'purple',
                'docs_url'    => 'https://www.transitops.io/docs/customer-portal',
            ],
        ];
    }
}
