...
use Transitops\FleetOps\Integrations\Lalamove\LalamoveMarket;
use Transitops\FleetOps\Integrations\Lalamove\LalamoveServiceType;
...
class ResolvedIntegratedVendor
{
    ...
    {
        return Utils::assetFromTransitops('integrated-vendors/' . $code . '.png');
    }
