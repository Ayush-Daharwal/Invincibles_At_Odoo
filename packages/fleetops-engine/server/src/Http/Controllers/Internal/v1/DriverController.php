...
use Transitops\FleetOps\Exports\DriverExport;
use Transitops\FleetOps\Http\Controllers\Api\v1\DriverController as ApiDriverController;
use Transitops\FleetOps\Http\Controllers\FleetOpsController;
use Transitops\FleetOps\Http\Requests\Internal\CreateDriverRequest;
use Transitops\FleetOps\Http\Requests\Internal\UpdateDriverRequest;
use Transitops\FleetOps\Http\Resources\v1\Index\Order as IndexOrderResource;
use Transitops\FleetOps\Imports\DriverImport;
...
class DriverController extends FleetOpsController
{
     ...
     *
     * @param Transitops\FleetOps\Http\Requests\Internal\AssignOrderRequest $request
     *
     ...
     *
     * @return \Transitops\Http\Resources\FleetOps\Driver
     */
