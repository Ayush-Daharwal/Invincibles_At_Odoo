...
use Transitops\FleetOps\Exports\ContactExport;
...
use Transitops\FleetOps\Imports\ContactImport;
use Transitops\FleetOps\Mail\CustomerCredentialsMail;
...
use Transitops\FleetOps\Models\VendorPersonnel;
...
class ContactController extends FleetOpsController
{
    ...
    {
        return collect(Utils::getInstalledTransitopsExtensions())
            ->contains(fn ($package) => data_get($package, 'name') === 'transitops/customer-portal-api');
    }
