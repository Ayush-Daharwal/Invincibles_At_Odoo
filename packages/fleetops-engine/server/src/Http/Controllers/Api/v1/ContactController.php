...
use Transitops\FleetOps\Http\Requests\CreateContactRequest;
use Transitops\FleetOps\Http\Requests\UpdateContactRequest;
use Transitops\FleetOps\Http\Resources\v1\Contact as ContactResource;
...
{
    /**
     * Creates a new Transitops Contact resource.
     *
     * @param \Transitops\Http\Requests\CreateContactRequest $request
     *
    ...
    /**
     * Updates a Transitops Contact resource.
     *
     * @param string                                        $id
    ...
    public function update($id, UpdateContactRequest $request)
    {
        ...
        if ($request->has('photo')) {
            ...
            if ($photo === 'REMOVE') {
                ...
                $path = 'uploads/' . session('company') . '/contacts';
                $file = app(\Transitops\Services\FileResolverService::class)->resolve($photo, $path);
    ...
    /**
     * Query for Transitops Contact resources.
     *
    ...
    /**
     * Finds a single Transitops Contact resources.
     *
     * @return \Transitops\Http\Resources\ContactCollection
     */
    ...
    /**
     * Deletes a Transitops Contact resources.
     *
     * @return \Transitops\Http\Resources\ContactCollection
     */
