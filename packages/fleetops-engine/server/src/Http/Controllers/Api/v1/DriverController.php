...
use Transitops\FleetOps\Events\DriverLocationChanged;
use Transitops\FleetOps\Events\GeofenceEntered;
use Transitops\FleetOps\Events\GeofenceExited;
use Transitops\FleetOps\Events\VehicleLocationChanged;
use Transitops\FleetOps\Http\Requests\CreateDriverRequest;
use Transitops\FleetOps\Http\Requests\DriverSimulationRequest;
use Transitops\FleetOps\Http\Requests\UpdateDriverRequest;
use Transitops\FleetOps\Http\Resources\v1\DeletedResource;
use Transitops\FleetOps\Http\Resources\v1\Driver as DriverResource;
use Transitops\FleetOps\Jobs\CheckGeofenceDwell;
use Transitops\FleetOps\Jobs\SimulateDrivingRoute;
use Transitops\FleetOps\Models\Driver;
use Transitops\FleetOps\Models\Order;
use Transitops\FleetOps\Models\Vehicle;
use Transitops\FleetOps\Support\GeofenceIntersectionService;
use Transitops\FleetOps\Support\OSRM;
use Transitops\FleetOps\Support\Utils;
use Transitops\Http\Controllers\Controller;
use Transitops\Http\Requests\SwitchOrganizationRequest;
use Transitops\Http\Resources\Organization;
use Transitops\LaravelMysqlSpatial\Types\Point;
use Transitops\Models\Company;
use Transitops\Models\CompanyUser;
use Transitops\Models\User;
use Transitops\Models\UserDevice;
use Transitops\Models\VerificationCode;
...
{
    /**
     * Creates a new Transitops Driver resource.
     *
     * @return \Transitops\Http\Resources\Driver
     */
    public function create(CreateDriverRequest $request)
    {
        ...
        if ($request->has('photo')) {
            ...
            $file = app(\Transitops\Services\FileResolverService::class)->resolve($request->input('photo'), $path);
    ...
    /**
     * Updates a Transitops Driver resource.
     *
     * @param string                                       $id
     * @param \Transitops\Http\Requests\UpdateDriverRequest $request
     *
     * @return \Transitops\Http\Resources\Driver
     */
    ...
    /**
     * Query for Transitops Driver resources.
     *
     * @return \Transitops\Http\Resources\DriverCollection
     */
    ...
    /**
     * Finds a single Transitops Driver resources.
     *
     * @param string $id
     *
     * @return \Transitops\Http\Resources\DriverCollection
    ...
    /**
     * Deletes a Transitops Driver resources.
     *
     * @param string $id
     *
     * @return \Transitops\Http\Resources\DriverCollection
     ...
     *          - Order.
     *
     * @param \Transitops\Http\Requests\DriverSimulationRequest $request
     *
     * @return \Illuminate\Http\Response
     */
