...
use Transitops\FleetOps\Http\Requests\CreatePayloadRequest;
use Transitops\FleetOps\Http\Requests\UpdatePayloadRequest;
use Transitops\FleetOps\Http\Resources\v1\DeletedResource;
use Transitops\FleetOps\Http\Resources\v1\Payload as PayloadResource;
...
{
    /**
     * Creates a new Transitops Payload resource.
     *
     * @param \Transitops\Http\Requests\CreatePayloadRequest $request
     *
     * @return \Transitops\Http\Resources\Payload
     */
    ...
    /**
     * Updates a Transitops Payload resource.
     *
     * @param string                                        $id
     * @param \Transitops\Http\Requests\UpdatePayloadRequest $request
     *
     * @return \Transitops\Http\Resources\Payload
     */
    ...
    /**
     * Query for Transitops Payload resources.
     *
     * @return \Transitops\Http\Resources\PayloadCollection
     */
    ...
    /**
     * Finds a single Transitops Payload resources.
     *
     * @return \Transitops\Http\Resources\Payload
     */
    ...
    /**
     * Deletes a Transitops Payload resources.
     *
     * @return \Transitops\Http\Resources\Payload
     */
