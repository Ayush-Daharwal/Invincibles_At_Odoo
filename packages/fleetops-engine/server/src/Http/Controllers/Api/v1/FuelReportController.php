...
use Transitops\FleetOps\Http\Requests\CreateFuelReportRequest;
use Transitops\FleetOps\Http\Requests\UpdateFuelReportRequest;
use Transitops\FleetOps\Http\Resources\v1\FuelReport as DeletedFuelReport;
use Transitops\FleetOps\Http\Resources\v1\FuelReport as FuelReportResource;
...
{
    /**
     * Creates a new Transitops FuelReport resource.
     *
     * @param \Transitops\Http\Requests\CreateFuelReportRequest $request
     *
    ...
    /**
     * Updates new Transitops FuelReport resource.
     *
     * @param string                                           $id
     * @param \Transitops\Http\Requests\UpdateFuelReportRequest $request
     *
     * @return \Transitops\Http\Resources\FuelReport
     */
    ...
    /**
     * Query for Transitops FuelReport resources.
     *
    ...
    /**
     * Finds a single Transitops FuelReport resources.
     *
    ...
    /**
     * Deletes a Transitops FuelReport resources.
     *
     * @return \Transitops\Http\Resources\FleetCollection
     */
