...
use Transitops\FleetOps\Http\Requests\CreateCustomerOrderRequest;
use Transitops\FleetOps\Http\Requests\CreateCustomerRequest;
use Transitops\FleetOps\Http\Requests\UpdateContactRequest;
use Transitops\FleetOps\Http\Requests\VerifyCreateCustomerRequest;
use Transitops\FleetOps\Http\Resources\v1\Customer as CustomerResource;
use Transitops\FleetOps\Http\Resources\v1\Order as OrderResource;
use Transitops\FleetOps\Http\Resources\v1\Place as PlaceResource;
...
use Transitops\FleetOps\Support\CustomerAuth;
 ...
 * authenticates entirely with the Fleet-Ops API credential (`tro_live_…`) on
 ...
 * the standard `transitops.api` middleware that resolves the API credential
