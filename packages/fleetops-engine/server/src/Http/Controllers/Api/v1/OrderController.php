...
use Transitops\FleetOps\Exceptions\CustomerUserConflictException;
use Transitops\FleetOps\Exceptions\UserAlreadyExistsException;
use Transitops\FleetOps\Flow\Activity;
use Transitops\FleetOps\Http\Requests\CreateOrderRequest;
use Transitops\FleetOps\Http\Requests\ScheduleOrderRequest;
use Transitops\FleetOps\Http\Requests\UpdateOrderRequest;
...
use Transitops\FleetOps\Jobs\FinalizeApiOrderCreation;
...
use Transitops\Http\Resources\Comment as CommentResource;
...
class OrderController extends Controller
{
    ...
    /**
     * Creates a new Transitops Order resource.
     *
     * @param Request|CreateOrderRequest $request
     *
     * @return \Transitops\Http\Resources\Order
     */
    ...
    /**
     * Updates a Transitops Order resource.
     *
     * @param string $id
     *
     * @return \Transitops\Http\Resources\Order
    ...
    /**
     * Query for Transitops Order resources.
     *
     * @return \Transitops\Http\Resources\OrderCollection
     */
    ...
    /**
     * Finds a single Transitops Order resources.
     *
     * @return \Transitops\Http\Resources\OrderCollection
     */
    ...
    /**
     * Deletes a Transitops Order resources.
     *
     * @return \Transitops\Http\Resources\OrderCollection
     */
     ...
     *
     * @return \Transitops\FleetOps\Http\Resources\ProofResource
     *
