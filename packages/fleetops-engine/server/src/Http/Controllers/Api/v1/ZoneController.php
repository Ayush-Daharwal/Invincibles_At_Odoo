...
use Transitops\FleetOps\Http\Requests\CreateZoneRequest;
use Transitops\FleetOps\Http\Requests\UpdateZoneRequest;
use Transitops\FleetOps\Http\Resources\v1\DeletedResource;
use Transitops\FleetOps\Http\Resources\v1\Zone as ZoneResource;
...
{
    /**
     * Creates a new Transitops Zone resource.
     *
     * @param \Transitops\Http\Requests\CreateZoneRequest $request
     *
     * @return \Transitops\Http\Resources\Zone
     */
    ...
    /**
     * Updates a Transitops Zone resource.
     *
     * @param string                                     $id
     * @param \Transitops\Http\Requests\UpdateZoneRequest $request
     *
     * @return \Transitops\Http\Resources\Zone
     */
    ...
    /**
     * Query for Transitops Zone resources.
     *
     * @return \Transitops\Http\Resources\ZoneCollection
     */
    ...
    /**
     * Finds a single Transitops Zone resources.
     *
     * @return \Transitops\Http\Resources\ZoneCollection
     */
    ...
    /**
     * Deletes a Transitops Zone resources.
     *
     * @return \Transitops\Http\Resources\ZoneCollection
     */
