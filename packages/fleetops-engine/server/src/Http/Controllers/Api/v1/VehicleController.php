...
use Transitops\FleetOps\Http\Requests\CreateVehicleRequest;
use Transitops\FleetOps\Http\Requests\UpdateVehicleRequest;
use Transitops\FleetOps\Http\Resources\v1\DeletedResource;
use Transitops\FleetOps\Http\Resources\v1\Vehicle as VehicleResource;
...
{
    /**
     * Creates a new Transitops Vehicle resource.
     *
     * @param \Transitops\Http\Requests\CreateVehicleRequest $request
     *
     * @return \Transitops\Http\Resources\Vehicle
     */
    ...
    /**
     * Updates a Transitops Vehicle resource.
     *
     * @param string                                        $id
     * @param \Transitops\Http\Requests\UpdateVehicleRequest $request
     *
     * @return \Transitops\Http\Resources\Vehicle
     */
    ...
    /**
     * Query for Transitops Vehicle resources.
     *
     * @return \Transitops\Http\Resources\VehicleCollection
     */
    ...
    /**
     * Finds a single Transitops Vehicle resources.
     *
     * @param string $id
     *
     * @return \Transitops\Http\Resources\VehicleCollection
    ...
    /**
     * Deletes a Transitops Vehicle resources.
     *
     * @param string $id
     *
     * @return \Transitops\Http\Resources\VehicleCollection
