...
use Transitops\FleetOps\Http\Requests\CreateTrackingNumberRequest;
use Transitops\FleetOps\Http\Requests\DecodeTrackingNumberQR;
use Transitops\FleetOps\Http\Resources\v1\DeletedResource;
use Transitops\FleetOps\Http\Resources\v1\TrackingNumber as TrackingNumberResource;
use Transitops\FleetOps\Models\TrackingNumber;
...
{
    /**
     * Creates a new Transitops TrackingNumber resource.
     *
     * @param \Transitops\Http\Requests\CreateTrackingNumberRequest $request
     *
     * @return \Transitops\Http\Resources\TrackingNumber
     */
    ...
    /**
     * Query for Transitops TrackingNumber resources.
     *
     * @return \Transitops\Http\Resources\TrackingNumberCollection
     */
    ...
    /**
     * Finds a single Transitops TrackingNumber resources.
     *
     * @return \Transitops\Http\Resources\TrackingNumberCollection
     */
    ...
    /**
     * Deletes a Transitops TrackingNumber resources.
     *
     * @return \Transitops\Http\Resources\TrackingNumberCollection
     */
    ...
    public function fromQR(DecodeTrackingNumberQR $request)
    {
        ...
        $resourceNamespace = '\\Transitops\\Http\\Resources\\v1\\' . $modelType;
