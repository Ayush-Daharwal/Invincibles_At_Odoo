...
use Transitops\FleetOps\Http\Requests\CreatePurchaseRateRequest;
use Transitops\FleetOps\Http\Resources\v1\PurchaseRate as PurchaseRateResource;
...
use Transitops\FleetOps\Models\ServiceRate;
...
{
    /**
     * Creates a new Transitops PurchaseRate resource.
     *
     * @param \Transitops\Http\Requests\CreatePurchaseRateRequest $request
     *
     * @return \Transitops\Http\Resources\PurchaseRate
     */
     ...
     *
     * @param \Transitops\Models\ServiceQuote                     $serviceQuote
     * @param \Transitops\Http\Requests\CreatePurchaseRateRequest $request
     *
     * @return \Transitops\Models\Order|null
     */
    private function createOrderFromServiceQuote(?ServiceQuote $serviceQuote, CreatePurchaseRateRequest $request): ?Order
    {
        // if integrated vendor service quote create order with vendor first then create transitops order
    ...
    /**
     * Query for Transitops PurchaseRate resources.
     *
     * @return \Transitops\Http\Resources\PurchaseRateCollection
     */
    ...
    /**
     * Finds a single Transitops PurchaseRate resources.
     *
     * @return \Transitops\Http\Resources\PurchaseRateCollection
     */
