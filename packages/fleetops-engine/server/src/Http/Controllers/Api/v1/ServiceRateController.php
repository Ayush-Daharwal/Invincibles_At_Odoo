...
use Transitops\FleetOps\Http\Requests\CreateServiceRateRequest;
use Transitops\FleetOps\Http\Requests\UpdateServiceRateRequest;
use Transitops\FleetOps\Http\Resources\v1\DeletedResource;
use Transitops\FleetOps\Http\Resources\v1\ServiceRate as ServiceRateResource;
use Transitops\FleetOps\Models\ServiceRate;
use Transitops\FleetOps\Models\ServiceRateFee;
...
{
    /**
     * Creates a new Transitops ServiceRate resource.
     *
     * @param \Transitops\Http\Requests\CreateServiceRateRequest $request
     *
     * @return \Transitops\Http\Resources\ServiceRate
     */
    ...
    /**
     * Updates a Transitops ServiceRate resource.
     *
     * @param string                                            $id
     * @param \Transitops\Http\Requests\UpdateServiceRateRequest $request
     *
     * @return \Transitops\Http\Resources\ServiceRate
     */
    ...
    /**
     * Query for Transitops ServiceRate resources.
     *
     * @return \Transitops\Http\Resources\ServiceRateCollection
     */
    ...
    /**
     * Finds a single Transitops ServiceRate resources.
     *
     * @return \Transitops\Http\Resources\ServiceRateCollection
     */
    ...
    /**
     * Deletes a Transitops ServiceRate resources.
     *
     * @return \Transitops\Http\Resources\ServiceRateCollection
     */
