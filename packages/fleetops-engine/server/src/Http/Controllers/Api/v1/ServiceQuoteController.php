...
use Transitops\FleetOps\Http\Requests\QueryServiceQuotesRequest;
use Transitops\FleetOps\Http\Resources\v1\ServiceQuote as ServiceQuoteResource;
...
use Transitops\FleetOps\Models\ServiceQuoteItem;
...
{
    /**
     * Query for Transitops ServiceQuote resources.
     *
     * @return \Transitops\FleetOps\Http\Resources\ServiceQuoteCollection
     */
    ...
    /**
     * Query for Transitops ServiceQuote from preliminary data resources.
     *
     * @param \Transitops\Http\Requests\QueryServiceQuotesRequest $request
     *
     * @return \Transitops\Http\Resources\ServiceQuoteCollection
     */
    public function queryFromPreliminary(QueryServiceQuotesRequest $request)
    {
        ...
        if ($facilitator && Utils::isIntegratedVendorId($facilitator)) {
            ...
            if ($integratedVendor) {
                try {
                    /** @var \Transitops\Models\ServiceQuote $serviceQuote */
    ...
    /**
     * Finds a single Transitops ServiceQuote resources.
     *
     * @return \Transitops\Http\Resources\ServiceQuoteCollection
     */
