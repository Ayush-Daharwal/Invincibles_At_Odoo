...
use Transitops\FleetOps\Http\Requests\CreatePartRequest;
use Transitops\FleetOps\Http\Requests\UpdatePartRequest;
use Transitops\FleetOps\Http\Resources\v1\DeletedResource;
use Transitops\FleetOps\Http\Resources\v1\Part as PartResource;
