...
class WorkOrder extends TransitopsResource
{
    /**
    ...
    protected function setTargetType(?array $resolved): ?array
    {
        ...
        // class_basename('Transitops\FleetOps\Models\Vehicle') -> 'Vehicle'
    ...
    protected function setAssigneeType(?array $resolved): ?array
    {
        ...
        // class_basename('Transitops\FleetOps\Models\Vendor') -> 'Vendor'
