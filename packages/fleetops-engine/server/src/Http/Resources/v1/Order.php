...
use Transitops\FleetOps\Models\Contact as ContactModel;
use Transitops\FleetOps\Support\Utils;
use Transitops\Http\Resources\Comment;
use Transitops\Http\Resources\File;
...
class Order extends TransitopsResource
{
    ...
    protected function transformMorphResource($model)
    {
        ...
        $resourceClass = \Transitops\Support\Find::httpResourceForModel($model);
