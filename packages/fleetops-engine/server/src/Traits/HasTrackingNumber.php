...
namespace Transitops\FleetOps\Traits;
...
trait HasTrackingNumber
{
     ...
     *
     * @param array|Point                         $location the location of the update, can be either [lat, lng] or a \Transitops\LaravelMysqlSpatial\Types\Point instance
     * @param \Transitops\Models\Proof|string|null $proof    resolvable proof of delivery/activity
     *
     * @return \Transitops\Models\TrackingStatus
     */
     ...
     *
     * @return \Transitops\Models\Proof|null
     */
