...
class SendDriverNotification extends Command
{
    ...
    protected $eventToNotification = [
        'assigned'           => \Transitops\FleetOps\Notifications\OrderAssigned::class,
        'canceled'           => \Transitops\FleetOps\Notifications\OrderCanceled::class,
        'dispatched'         => \Transitops\FleetOps\Notifications\OrderDispatched::class,
        'ping'               => \Transitops\FleetOps\Notifications\OrderPing::class,
    ];
