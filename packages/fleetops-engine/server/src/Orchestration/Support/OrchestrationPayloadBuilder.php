...
namespace Transitops\FleetOps\Orchestration\Support;
...
class OrchestrationPayloadBuilder
{
    ...
    /**
     * Build normalized route tasks from Transitops orders.
     *
     * Transitops orders must remain atomic during allocation. A task contains
    ...
    /**
     * Build normalized capacity-only tasks from Transitops orders.
     *
    ...
    /**
     * Return Transitops's canonical ordered stops for an order:
