...
class Fleet extends Model
{
    ...
    {
        return $this->belongsTo(\Transitops\Models\File::class, 'image_uuid', 'uuid');
    }
    ...
    {
        return data_get($this, 'photo.url', 'https://s3.ap-northeast-2.amazonaws.com/transitops/public/default-fleet.png');
    }
