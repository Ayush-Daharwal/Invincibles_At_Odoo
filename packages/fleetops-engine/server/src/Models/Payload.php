...
class Payload extends Model
{
    ...
    public function setEntities($entities = [])
    {
        ...
        foreach ($entities as $attributes) {
            ...
            if (isset($attributes['photo'])) {
                ...
                $file = app(\Transitops\Services\FileResolverService::class)->resolve($attributes['photo'], $path);
     ...
     *
     * @return \Transitops\Models\Place|null
     */
     ...
     *
     * @param Point                               $location
     * @param \Transitops\Models\Proof|string|null $proof    resolvable proof of delivery/activity
     *
     * @return $this
     */
