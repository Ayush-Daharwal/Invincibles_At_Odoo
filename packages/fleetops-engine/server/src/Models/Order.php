...
use Transitops\Casts\PolymorphicType;
use Transitops\FleetOps\Events\OrderCanceled;
use Transitops\FleetOps\Events\OrderCompleted;
use Transitops\FleetOps\Events\OrderDispatched;
use Transitops\FleetOps\Events\OrderDriverAssigned;
use Transitops\FleetOps\Flow\Activity;
use Transitops\FleetOps\Support\LabelPdf;
use Transitops\FleetOps\Support\OrderTracker;
use Transitops\FleetOps\Support\Utils;
use Transitops\FleetOps\Traits\HasTrackingNumber;
...
use Transitops\Traits\HasCustomFields;
use Transitops\Traits\HasInternalId;
use Transitops\Traits\HasMetaAttributes;
...
use Transitops\Traits\SendsWebhooks;
...
class Order extends Model
{
    ...
    public static function boot(): void
    {
        ...
        Relation::morphMap(
            [
                'Transitops\\Models\\Contact'   => Contact::class,
                '\\Transitops\\Models\\Contact' => Contact::class,
                'Transitops\\Models\\Driver'    => Driver::class,
                '\\Transitops\\Models\\Driver'  => Driver::class,
                'Transitops\\Models\\Vendor'    => Vendor::class,
                '\\Transitops\\Models\\Vendor'  => Vendor::class,
            ]
        );
    }
    ...
    public function attachFiles($uploads): self
    {
        ...
        \Transitops\Models\File::whereIn('uuid', $ids)->get()->each(function ($file) {
            $file->setKey($this);
        });
    ...
    {
        return $this->belongsTo(\Transitops\Models\Company::class);
    }

    public function createdBy(): BelongsTo
    {
        return $this->belongsTo(\Transitops\Models\User::class);
    }
    ...
    {
        return $this->hasMany(\Transitops\Models\Comment::class, 'subject_uuid')->whereNull('parent_comment_uuid')->latest();
    }

    public function files(): HasMany
    {
        return $this->hasMany(\Transitops\Models\File::class, 'subject_uuid')->latest();
    }
    ...
    public function cancel()
    {
        ...
        if ($this->isIntegratedVendorOrder()) {
            ...
            if (method_exists($api, 'cancelFromTransitopsOrder')) {
                $api->cancelFromTransitopsOrder($this);
            }
        }
