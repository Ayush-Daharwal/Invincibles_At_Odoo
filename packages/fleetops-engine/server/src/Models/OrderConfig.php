...
use Transitops\FleetOps\Casts\OrderConfigEntities;
...
class OrderConfig extends Model
{
    ...
    {
        return $this->belongsTo(\Transitops\Models\Category::class);
    }
    ...
    {
        return $this->morphMany(\Transitops\Models\CustomField::class, 'subject', 'subject_type', 'subject_uuid');
    }
