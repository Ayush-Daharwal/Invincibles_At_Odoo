...
class Waypoint extends Model
{
     ...
     *
     * @param \Transitops\Models\Place|string                    $place   the place instance or identifier (UUID or public_id)
     * @param \Transitops\Models\Order|\Transitops\Models\Payload $order   the order or payload model to scope the search
