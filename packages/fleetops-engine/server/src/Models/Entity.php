...
use Transitops\FleetOps\Traits\PayloadAccessors;
...
class Entity extends Model
{
    ...
    {
        return $this->hasMany(\Transitops\Models\File::class);
    }
    ...
    {
        return data_get($this, 'photo.url', 'https://s3.ap-southeast-1.amazonaws.com/tro-assets/static/parcels/medium.png');
    }
