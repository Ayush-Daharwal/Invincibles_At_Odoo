...
class Contact extends Model
{
    ...
    {
        return $this->belongsTo(\Transitops\Models\Company::class, 'company_uuid');
    }
    ...
    {
        return $this->belongsTo(\Transitops\Models\File::class);
    }
    ...
    {
        return $this->hasMany(\Transitops\Models\UserDevice::class, 'user_uuid', 'user_uuid');
    }
    ...
    {
        return data_get($this, 'photo.url', 'https://s3.ap-southeast-1.amazonaws.com/tro-assets/static/no-avatar.png');
    }
