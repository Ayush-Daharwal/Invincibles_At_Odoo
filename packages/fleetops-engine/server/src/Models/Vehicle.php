...
use Transitops\FleetOps\Support\VehicleData;
...
class Vehicle extends Model
{
    ...
    protected $attributes = [
        'avatar_url' => 'https://tro-assets.s3-ap-southeast-1.amazonaws.com/static/vehicle-icons/mini_bus.svg',
        'status'     => 'available',
    ];
    ...
    {
        return data_get($this, 'photo.url', 'https://s3.ap-southeast-1.amazonaws.com/tro-assets/static/vehicle-placeholder.png');
    }
    ...
    public static function getAvatarOptions(?callable $customQueryCallback = null)
    {
        ...
        $avatars = collect($options)->mapWithKeys(
            function ($option) {
                ...
                return [$key => Utils::assetFromTransitops('static/vehicle-icons/' . $option)];
            }
        );
