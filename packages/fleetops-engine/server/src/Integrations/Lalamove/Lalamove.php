...
namespace Transitops\FleetOps\Integrations\Lalamove;

use Transitops\FleetOps\Exceptions\IntegratedVendorException;
...
use Transitops\FleetOps\Support\ParsePhone;
...
class Lalamove
{
    ...
    public function cancelFromTransitopsOrder(Order $order)
    {
