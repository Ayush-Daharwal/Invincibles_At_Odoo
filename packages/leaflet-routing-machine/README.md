...
Download [latest release](https://github.com/transitops/leaflet-routing-machine/releases), or obtain the latest release via [unpkg.com](https://unpkg.com/).
...
```sh
npm install --save @transitops/leaflet-routing-machine
```

```sh
yarn add @transitops/leaflet-routing-machine
```
...
const map = new L.Map();
const serviceUrl = 'https://routing.transitops.io';
