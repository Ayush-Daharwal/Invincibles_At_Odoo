...
ES6 modules that integrates seamlessly with ember-cli and the Transitops ecosystem.
...
```bash
npm install @transitops/ember-accounting
```
...
```js
import formatMoney from '@transitops/ember-accounting/format-money'
```

Although you can import everything as expected:

```js
import accounting from '@transitops/ember-accounting'
```
...
import { currency, number } from '@transitops/ember-accounting/settings';
