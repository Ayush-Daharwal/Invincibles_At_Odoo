        ...
        return fg(['node_modules/*/package.json', 'node_modules/*/*/package.json'])
            .then((results) => {
                for (let i = 0; i < results.length; i++) {
                    ...
                    if (!packageData || !packageData.keywords || !packageData.keywords.includes('transitops-extension')) {
                        continue;
                    }
                    ...
                    extensions.push(only(packageData, ['name', 'description', 'version', 'transitops', 'keywords', 'license', 'repository']));
                }
...
module.exports = class TransitopsExtensionsIndexer extends Plugin {
    constructor() {
        super([]);
    }
