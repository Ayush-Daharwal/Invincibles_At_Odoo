...
export function registerWidgets(widgetService) {
    ...
    const widgets = [
        new Widget({
            ...
            icon: 'user-check',
            component: new ExtensionComponent('@transitops/iam-engine', 'widget/kpi-active-users'),
        ...
        new Widget({
            ...
            component: new ExtensionComponent('@transitops/iam-engine', 'widget/kpi-pending-invites'),
            grid_options: kpiGridOptions,
            category: 'KPI Tiles',
            default: true,
        }),
        new Widget({
            ...
            icon: 'user-slash',
            component: new ExtensionComponent('@transitops/iam-engine', 'widget/kpi-inactive-users'),
            grid_options: kpiGridOptions,
            category: 'KPI Tiles',
            default: true,
        }),
        new Widget({
            ...
            icon: 'bed',
            component: new ExtensionComponent('@transitops/iam-engine', 'widget/kpi-dormant-users'),
            grid_options: kpiGridOptions,
            category: 'KPI Tiles',
            default: true,
        }),
        new Widget({
            ...
            icon: 'lock',
            component: new ExtensionComponent('@transitops/iam-engine', 'widget/kpi-mfa-coverage'),
            grid_options: kpiGridOptions,
            category: 'KPI Tiles',
            default: true,
        }),
        new Widget({
            ...
            icon: 'user-tag',
            component: new ExtensionComponent('@transitops/iam-engine', 'widget/kpi-roles'),
            grid_options: kpiGridOptions,
            category: 'KPI Tiles',
            default: true,
        }),
        new Widget({
            ...
            icon: 'file-shield',
            component: new ExtensionComponent('@transitops/iam-engine', 'widget/kpi-policies'),
            grid_options: kpiGridOptions,
            category: 'KPI Tiles',
            default: true,
        }),
        new Widget({
            ...
            icon: 'chart-column',
            component: new ExtensionComponent('@transitops/iam-engine', 'widget/user-type-creation-trend'),
        ...
        new Widget({
            ...
            icon: 'user-lock',
            component: new ExtensionComponent('@transitops/iam-engine', 'widget/access-risk'),
            grid_options: insightGridOptions,
            category: 'Security',
            default: true,
        }),
        new Widget({
            ...
            component: new ExtensionComponent('@transitops/iam-engine', 'widget/policy-surface'),
            grid_options: insightGridOptions,
            category: 'Governance',
            default: true,
        }),
        new Widget({
            ...
            component: new ExtensionComponent('@transitops/iam-engine', 'widget/recent-activity'),
            grid_options: insightGridOptions,
            category: 'Operations',
            default: true,
        }),
        new Widget({
            ...
            icon: 'bolt',
            component: new ExtensionComponent('@transitops/iam-engine', 'widget/quick-actions'),
        ...
        new Widget({
            ...
            icon: 'user-shield',
            component: new ExtensionComponent('@transitops/iam-engine', 'widget/iam-metrics'),
