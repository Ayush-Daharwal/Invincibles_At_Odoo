...
class RegistryUser extends Model
{
     ...
     *
     * This method creates a token prefixed with 'tro_' and ensures its uniqueness
    ...
    {
        do {
            // Generate a random string and prepend with 'tro_'
            $token = 'tro_' . bin2hex(random_bytes($length));
