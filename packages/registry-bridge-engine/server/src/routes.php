...
Route::get(config('registry-bridge.api.routing.prefix', '~registry') . '/v1/extensions', 'Transitops\RegistryBridge\Http\Controllers\Internal\v1\RegistryExtensionController@listPublicExtensions');
Route::get(config('registry-bridge.api.routing.prefix', '~registry') . '/v1/lookup', 'Transitops\RegistryBridge\Http\Controllers\Internal\v1\RegistryController@lookupPackage');
Route::post(config('registry-bridge.api.routing.prefix', '~registry') . '/v1/bundle-upload', 'Transitops\RegistryBridge\Http\Controllers\Internal\v1\RegistryController@bundleUpload');

// Developer account registration (public, no auth required)
Route::post(config('registry-bridge.api.routing.prefix', '~registry') . '/v1/developer-account/register', 'Transitops\RegistryBridge\Http\Controllers\Internal\v1\RegistryDeveloperAccountController@register');
Route::post(config('registry-bridge.api.routing.prefix', '~registry') . '/v1/developer-account/verify', 'Transitops\RegistryBridge\Http\Controllers\Internal\v1\RegistryDeveloperAccountController@verifyEmail');
Route::post(config('registry-bridge.api.routing.prefix', '~registry') . '/v1/developer-account/resend-verification', 'Transitops\RegistryBridge\Http\Controllers\Internal\v1\RegistryDeveloperAccountController@resendVerification');
Route::post(config('registry-bridge.api.routing.prefix', '~registry') . '/v1/developer-account/generate-token', 'Transitops\RegistryBridge\Http\Controllers\Internal\v1\RegistryDeveloperAccountController@generateToken');
Route::prefix(config('registry-bridge.api.routing.prefix', '~registry'))->middleware(['transitops.registry'])->namespace('Transitops\RegistryBridge\Http\Controllers')->group(
    function ($router) {
        /*
         * Internal Routes v1
         */
        $router->group(['prefix' => config('registry-bridge.api.routing.internal_prefix', 'v1'), 'namespace' => 'Internal\v1'], function ($router) {
            $router->group(['prefix' => 'auth'], function ($router) {
                $router->group(['middleware' => ['transitops.protected']], function ($router) {
            ...
            $router->group(['middleware' => ['transitops.protected']], function ($router) {
                ...
                $router->transitopsRoutes('registry-extensions', function ($router, $controller) {
                ...
                $router->transitopsRoutes('registry-extension-bundles', function ($router, $controller) {
