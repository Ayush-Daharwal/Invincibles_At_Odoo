...
namespace Transitops\RegistryBridge\Http\Controllers\Internal\v1;

use Transitops\Exceptions\TransitopsRequestValidationException;
use Transitops\Http\Requests\AdminRequest;
use Transitops\Models\Setting;
use Transitops\RegistryBridge\Http\Controllers\RegistryBridgeController;
use Transitops\RegistryBridge\Http\Requests\CreateRegistryExtensionRequest;
use Transitops\RegistryBridge\Http\Requests\RegistryExtensionActionRequest;
use Transitops\RegistryBridge\Http\Resources\PublicRegistryExtension;
use Transitops\RegistryBridge\Models\RegistryExtension;
use Transitops\RegistryBridge\Support\Utils;
...
class RegistryExtensionController extends RegistryBridgeController
{
    ...
    {
        $registryHost     = config('registry-bridge.registry.host', env('REGISTRY_HOST', 'https://registry.transitops.io'));
    ...
    {
        $currentRegistryHost     = config('registry-bridge.registry.host', env('REGISTRY_HOST', 'https://registry.transitops.io'));
