...
/**
 * -------------------------------------------
 * Transitops Core API Configuration
 * -------------------------------------------
 */
...
return [
    ...
    'registry' => [
        'host' => env('REGISTRY_HOST', 'https://registry.transitops.io'),
    ...
    'extensions' => [
        ...
        'protected_prefixes' => explode(',', env('REGISTRY_PROTECTED_PREFIXES', '@transitops,transitops,@tro,@transitops-extension,@tro-extension'))
    ],
