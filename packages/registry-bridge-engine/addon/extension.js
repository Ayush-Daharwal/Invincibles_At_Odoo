...
export default {
    setupExtension(app, universe) {
        ...
        menuService.registerHeaderMenuItem('Extensions', 'console.extensions', {
            ...
            description: 'Discover, install, and publish extensions to the Transitops extension registry.',
            shortcuts: [
                {
                    title: 'Explore',
        ...
        menuService.registerAdminMenuPanel(
            ...
            [
                new MenuItem({
                    ...
                    icon: 'gear',
                    component: new ExtensionComponent('@transitops/registry-bridge-engine', 'registry-admin-config'),
                }),
                new MenuItem({
                    title: 'Awaiting Review',
                    icon: 'gavel',
                    component: new ExtensionComponent('@transitops/registry-bridge-engine', 'extension-reviewer-control'),
                }),
                new MenuItem({
                    title: 'Pending Publish',
                    icon: 'rocket',
                    component: new ExtensionComponent('@transitops/registry-bridge-engine', 'extension-pending-publish-viewer'),
                }),
            ],
            {
