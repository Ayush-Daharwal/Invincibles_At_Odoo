...
module('Integration | Component | dashboard', function (hooks) {
    ...
    test('it renders', async function (assert) {
        ...
        assert.dom('.transitops-dashboard-grid').exists();
    ...
    test('it supports an opt-in sticky header class', async function (assert) {
        ...
        assert.dom('.transitops-dashboard-grid').hasClass('transitops-dashboard-grid--sticky');

        await render(hbs`<Dashboard />`);

        assert.dom('.transitops-dashboard-grid').doesNotHaveClass('transitops-dashboard-grid--sticky');
    });
});
