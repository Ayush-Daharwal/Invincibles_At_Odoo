# TransitopsPagination Component

## Usage

To use the Transitops Pagination component, you can import it into your Ember component and include it in your template as follows:

```hbs

<TransitopsPagination @currentPage={{this.currentPage}} @totalPages={{this.totalPages}} @onPageChange={{this.handlePageChange}} />

```

You can customize the Transitops Pagination component by passing in different props:
