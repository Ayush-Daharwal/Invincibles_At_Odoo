...
module.exports = {
    ...
    content: [
        ...
        './addon/**/*.{hbs,js}',
        './addon/**/*.css',
        // All Transitops packages (both pnpm symlinked and normal installs)
        './node_modules/@transitops+*/**/addon/**/*.{hbs,js}',
        './node_modules/@transitops/**/addon/**/*.{hbs,js}',
        // Explicit ember-ui paths
        './node_modules/@transitops/ember-ui/addon/templates/**/*.{hbs,js}',
        './node_modules/@transitops/ember-ui/addon/components/**/*.{hbs,js}',
        // Explicit support for .pnpm paths (for unhoisted deps)
        './node_modules/.pnpm/@transitops+*/**/addon/**/*.{hbs,js}',
        // Engine packages
