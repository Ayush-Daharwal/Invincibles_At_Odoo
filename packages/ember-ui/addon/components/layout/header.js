...
export default class LayoutHeaderComponent extends Component {
    ...
    mergeOrganizationMenuItems(organizationMenuItems = []) {
        ...
        if (this.hasExtension('@transitops/registry-bridge-engine')) {
    ...
    mergeUserMenuItems(userMenuItems = []) {
        ...
        if (this.hasExtension('@transitops/dev-engine')) {
            menuItems.pushObject({
        ...
        const supportMenuItems = [
            ...
            },
            {
                ...
                href: 'https://github.com/transitops/transitops/issues',
                target: '_support',
                text: 'Help & Support',
                icon: 'arrow-up-right-from-square',
            },
            {
                ...
                text: 'Documentation',
                icon: 'book-open',
                onClick: () => this.docsPanel.open('https://www.transitops.io/docs', { title: 'Transitops Documentation', source: 'user-menu' }),
            },
        ];
