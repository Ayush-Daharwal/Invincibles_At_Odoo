...
export default class TemplateBuilderQueryFormComponent extends Component {
    ...
    get resourceTypes() {
        ...
        return [
            { value: 'Transitops\\FleetOps\\Models\\Order', label: 'Order', icon: 'box' },
            { value: 'Transitops\\FleetOps\\Models\\Driver', label: 'Driver', icon: 'id-card' },
            { value: 'Transitops\\FleetOps\\Models\\Place', label: 'Place', icon: 'location-dot' },
            { value: 'Transitops\\FleetOps\\Models\\Vendor', label: 'Vendor', icon: 'building' },
            { value: 'Transitops\\FleetOps\\Models\\Contact', label: 'Contact', icon: 'address-book' },
            { value: 'Transitops\\FleetOps\\Models\\Issue', label: 'Issue', icon: 'triangle-exclamation' },
            { value: 'Transitops\\FleetOps\\Models\\Vehicle', label: 'Vehicle', icon: 'truck' },
            { value: 'Transitops\\FleetOps\\Models\\FuelReport', label: 'Fuel Report', icon: 'gas-pump' },
            { value: 'Transitops\\FleetOps\\Models\\PurchaseRate', label: 'Purchase Rate', icon: 'receipt' },
        ];
    }
