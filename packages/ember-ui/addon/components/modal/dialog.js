...
export default class ModalDialog extends Component {
    ...
    get sizeClass() {
        ...
        return isBlank(size) ? null : `tro--modal-${size}`;
    }

    /**
     * The id of the `.tro--modal-title` element
     *
     * @property titleId
     * @type string
     * @default null
    ...
    @action getOrSetTitleId(modalNode) {
        ...
        if (modalNode) {
            const titleNode = modalNode.querySelector('.tro--modal-title');
            if (titleNode) {
                //Get title id of .tro--modal-title
                nodeId = titleNode.id;
                if (!nodeId) {
