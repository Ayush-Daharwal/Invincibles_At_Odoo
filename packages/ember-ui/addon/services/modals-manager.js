...
export default class ModalsManagerService extends Service {
    ...
    @action confirm(options = {}) {
        let modalClass = 'tro--confirm-modal modal-sm';

        if (typeof options.modalClass === 'string') {
            modalClass = `tro--confirm-modal ${options.modalClass}`;
        }
    ...
    @action alert(options = {}) {
        let modalClass = 'tro--alert-modal modal-sm';

        if (typeof options.modalClass === 'string') {
            modalClass = `tro--alert-modal ${options.modalClass}`;
        }
