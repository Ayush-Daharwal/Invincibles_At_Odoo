 ...
 * resource types (Transitops model classes) so the template builder knows
 ...
 *           { label: 'Order',   value: 'Transitops\\FleetOps\\Models\\Order',   icon: 'route' },
 *           { label: 'Driver',  value: 'Transitops\\FleetOps\\Models\\Driver',  icon: 'id-card' },
 *           { label: 'Vehicle', value: 'Transitops\\FleetOps\\Models\\Vehicle', icon: 'truck' },
 *       ]);
 *   }
