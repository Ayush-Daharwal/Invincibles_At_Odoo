...
export const DOCS_BASE_URL = 'https://www.transitops.io/docs/';
const OFFICIAL_DOC_HOSTS = ['www.transitops.io', 'transitops.io', 'docs.transitops.io'];
...
export default class DocsPanelService extends Service {
    ...
    get canEmbed() {
        ...
        try {
            ...
            return OFFICIAL_DOC_HOSTS.includes(parsed.hostname) && (parsed.hostname === 'docs.transitops.io' || parsed.pathname.startsWith('/docs'));
        } catch {
            return false;
        }
    }
    ...
    get bodyWrapperClass() {
        if (this.isIframeThemeDark) {
            return 'transitops-docs-panel-body transitops-docs-panel-body-dark';
        }

        return 'transitops-docs-panel-body transitops-docs-panel-body-light';
    }
    ...
    normalizeUrl(url, options = {}) {
        ...
        if (url.startsWith('/docs')) {
            return this.withDocsEmbedParams(`https://www.transitops.io${url}`, theme);
        }
