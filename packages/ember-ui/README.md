...
To install the Transitops Ember UI library, simply run the following command:

<code>npm install @transitops/ember-ui</code>

## Usage

Once you have installed the Transitops Components library, you can start using the components in your application. 

For more information on how to use each component, please refer to the documentation.

## Components

The following components are included in the Transitops Ember UI Components library:
