...
namespace Transitops\Valhalla\Providers;
 ...
 */
class ValhallaServiceProvider extends CoreServiceProvider
{
    /**
    ...
    public function boot()
    {
        ...
        $this->mergeConfigFrom(__DIR__ . '/../../config/valhalla.php', 'valhalla');
    }
}
