    ...
    setupExtension(app, universe) {
        ...
        const widgets = [
            new Widget({
                ...
                icon: 'code',
                component: new ExtensionComponent('@transitops/dev-engine', 'widget/kpi-api-requests'),
            ...
            new Widget({
                ...
                component: new ExtensionComponent('@transitops/dev-engine', 'widget/kpi-api-error-rate'),
                grid_options: { w: 3, h: 4, minW: 3, minH: 4 },
                category: 'KPI Tiles',
                default: true,
            }),
            new Widget({
                ...
                icon: 'gauge-high',
                component: new ExtensionComponent('@transitops/dev-engine', 'widget/kpi-api-latency'),
                grid_options: { w: 3, h: 4, minW: 3, minH: 4 },
                category: 'KPI Tiles',
                default: true,
            }),
            new Widget({
                ...
                icon: 'webhook',
                component: new ExtensionComponent('@transitops/dev-engine', 'widget/kpi-webhook-success'),
                grid_options: { w: 3, h: 4, minW: 3, minH: 4 },
                category: 'KPI Tiles',
                default: true,
            }),
            new Widget({
                ...
                icon: 'key',
                component: new ExtensionComponent('@transitops/dev-engine', 'widget/kpi-active-api-keys'),
                grid_options: { w: 3, h: 4, minW: 3, minH: 4 },
                category: 'KPI Tiles',
                default: true,
            }),
            new Widget({
                ...
                component: new ExtensionComponent('@transitops/dev-engine', 'widget/kpi-active-webhooks'),
                grid_options: { w: 3, h: 4, minW: 3, minH: 4 },
                category: 'KPI Tiles',
                default: true,
            }),
            new Widget({
                ...
                icon: 'webhook',
                component: new ExtensionComponent('@transitops/dev-engine', 'widget/kpi-webhook-failures'),
                grid_options: { w: 3, h: 4, minW: 3, minH: 4 },
                category: 'KPI Tiles',
                default: true,
            }),
            new Widget({
                ...
                icon: 'bolt',
                component: new ExtensionComponent('@transitops/dev-engine', 'widget/kpi-events-emitted'),
                grid_options: { w: 3, h: 4, minW: 3, minH: 4 },
                category: 'KPI Tiles',
                default: true,
            }),
            new Widget({
                ...
                icon: 'chart-line',
                component: new ExtensionComponent('@transitops/dev-engine', 'widget/api-traffic'),
            ...
            new Widget({
                ...
                icon: 'chart-column',
                component: new ExtensionComponent('@transitops/dev-engine', 'widget/webhook-delivery'),
                grid_options: { w: 6, h: 8, minW: 5, minH: 7 },
                category: 'Analytics',
                default: true,
            }),
            new Widget({
                ...
                icon: 'heart-pulse',
                component: new ExtensionComponent('@transitops/dev-engine', 'widget/endpoint-health'),
                grid_options: { w: 6, h: 8, minW: 5, minH: 7 },
                category: 'Operations',
                default: true,
            }),
            new Widget({
                ...
                icon: 'bolt',
                component: new ExtensionComponent('@transitops/dev-engine', 'widget/event-stream'),
                grid_options: { w: 6, h: 8, minW: 5, minH: 7 },
                category: 'Operations',
                default: true,
            }),
            new Widget({
                ...
                icon: 'timeline',
                component: new ExtensionComponent('@transitops/dev-engine', 'widget/developer-activity'),
                grid_options: { w: 6, h: 8, minW: 5, minH: 7 },
                category: 'Operations',
                default: true,
            }),
            new Widget({
                ...
                icon: 'link',
                component: new ExtensionComponent('@transitops/dev-engine', 'widget/quick-resources'),
                grid_options: { w: 6, h: 8, minW: 5, minH: 7 },
                category: 'Resources',
                default: true,
            }),
            new Widget({
                ...
                icon: 'code',
                component: new ExtensionComponent('@transitops/dev-engine', 'widget/api-metrics'),
